...
(function(process) {
  var axios = function(t) {
    ...
    var a = t.exports = function c(t) {
      ...
      var e = [s, void 0],
          n = Promise.resolve(t);
      for (c.interceptors.request.forEach(function(t) {
    ...
    function n(t) {
      return "[object ArrayBuffer]" === m.call(t);
    }
    function r(t) {
    ...
    function h(t, n) {
      if (null !== t && "undefined" != typeof t) {
        var r = e(t) || "object" == typeof t && !isNaN(t.length);
        if ("object" == typeof t || r || (t = [t]), r)
          for (var o = 0,
              i = t.length; i > o; o++)
            n.call(null, t[o], o, t);
        else
          for (var s in t)
            t.hasOwnProperty(s) && n.call(null, t[s], s, t);
      }
    }
    function d() {
      var t = {};
    ...
    (function(e) {
      ...
      t.exports = function(t) {
        return new Promise(function(r, o) {
          try {
            "undefined" != typeof window ? n(8)(r, o, t) : "undefined" != typeof e && n(8)(r, o, t);
          } catch (i) {
            o(i);
          }
        });
    ...
    t.exports = function(t, e, n) {
      var f = a(n.data, n.headers, n.transformRequest),
          l = o.merge(r.headers.common, r.headers[n.method] || {}, n.headers || {});
      o.isFormData(f) && delete l["Content-Type"];
      var p = new (XMLHttpRequest || ActiveXObject)("Microsoft.XMLHTTP");
      p.open(n.method.toUpperCase(), i(n.url, n.params), !0), p.onreadystatechange = function() {
        if (p && 4 === p.readyState) {
          var r = u(p.getAllResponseHeaders()),
              o = -1 !== ["text", ""].indexOf(n.responseType || "") ? p.responseText : p.response,
              i = {
                data: a(o, r, n.transformResponse),
                status: p.status,
                statusText: p.statusText,
                headers: r,
                config: n
              };
          (p.status >= 200 && p.status < 300 ? t : e)(i), p = null;
        }
      };
      var h = c(n.url) ? s.read(n.xsrfCookieName || r.xsrfCookieName) : void 0;
      ...
      }), n.withCredentials && (p.withCredentials = !0), n.responseType)
        try {
    ...
    (function(t, o, i) {
      (function() {
        ...
        function _(t, e) {
          e._state === Y ? j(t, e._result) : t._state === $ ? T(t, e._result) : C(e, void 0, function(e) {
            A(t, e);
          }, function(e) {
            T(t, e);
          });
        ...
        function x(t, e) {
          if (e.constructor === t.constructor)
            ...
            var n = w(e);
            n === z ? T(t, z.error) : void 0 === n ? j(t, e) : u(n) ? b(t, e, n) : j(t, e);
          }
        }
        function A(t, e) {
          t === e ? T(t, y()) : s(e) ? x(t, e) : j(t, e);
        }
        function E(t) {
          t._onerror && t._onerror(t._result), R(t);
        }
        function j(t, e) {
          t._state === K && (t._result = e, t._state = Y, 0 === t._subscribers.length || L(R, t));
        }
        function T(t, e) {
          t._state === K && (t._state = $, t._result = e, L(E, t));
        }
        function C(t, e, n, r) {
          var o = t._subscribers,
              i = o.length;
          t._onerror = null, o[i] = e, o[i + Y] = n, o[i + $] = r, 0 === i && t._state && L(R, t);
        }
        function R(t) {
        ...
        function P(t, e, n, r) {
          var o,
              ...
              c = u(n);
          if (c) {
            if (o = O(n, r), o === G ? (a = !0, i = o.error, o = null) : s = !0, e === o)
              return void T(e, v());
          } else
            o = r, s = !0;
          e._state !== K || (c && s ? A(e, o) : a ? T(e, i) : t === Y ? j(e, o) : t === $ && T(e, o));
        }
        function k(t, e) {
          try {
            e(function(e) {
        ...
        function D(t, e, n, r) {
          this._instanceConstructor = t, this.promise = new t(m, r), this._abortOnReject = n, this._validateInput(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._init(), 0 === this.length ? j(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && j(this.promise, this._result))) : T(this.promise, this._validationError());
        }
        function N() {
        ...
        function M(t) {
          this._id = ne++, this._state = void 0, this._result = void 0, this._subscribers = [], m !== t && (u(t) || N(), this instanceof M || B(), k(this, t));
        }
        var F;
        ...
        var U,
            ...
            J = new Array(1e3);
        U = "undefined" != typeof t && "[object process]" === {}.toString.call(t) ? f() : X ? l() : V ? p() : h();
        var K = void 0,
            Y = 1,
            $ = 2,
            z = new S,
        ...
        D.prototype._enumerate = function() {
          for (var t = this.length,
              e = this.promise,
              n = this._input,
              r = 0; e._state === K && t > r; r++)
            this._eachEntry(n[r], r);
        }, D.prototype._eachEntry = function(t, e) {
          var n = this._instanceConstructor;
          a(t) ? t.constructor === n && t._state !== K ? (t._onerror = null, this._settledAt(t._state, e, t._result)) : this._willSettleAt(n.resolve(t), e) : (this._remaining--, this._result[e] = this._makeResult(Y, e, t));
        }, D.prototype._settledAt = function(t, e, n) {
          var r = this.promise;
          r._state === K && (this._remaining--, this._abortOnReject && t === $ ? T(r, n) : this._result[e] = this._makeResult(t, e, n)), 0 === this._remaining && j(r, this._result);
        ...
        var Q = function(t, e) {
          return new W(this, t, !0, e).promise;
        },
            Z = function(t, e) {
              function n(t) {
                A(i, t);
              ...
              for (var s = t.length,
                  u = 0; i._state === K && s > u; u++)
                C(o.resolve(t[u]), void 0, n, r);
              return i;
            },
            te = function(t, e) {
              var n = this;
            ...
            ne = 0,
            re = M;
        M.all = Q, M.race = Z, M.resolve = te, M.reject = ee, M.prototype = {
          constructor: M,
          then: function(t, e) {
            var n = this,
                r = n._state;
        ...
        var oe = function() {
          var t;
          t = "undefined" != typeof o ? o : "undefined" != typeof window && window.document ? window : self;
        ...
        n(16).amd ? (r = function() {
          return ie;
        }.call(e, n, e, i), !(void 0 !== r && (i.exports = r))) : "undefined" != typeof i && i.exports ? i.exports = ie : "undefined" != typeof this && (this.ES6Promise = ie);
      }).call(this);
    }).call(e, n(10), function() {
      return this;
    }(), n(17)(t));
  }, function(t) {
    function e() {
    ...
    t.exports = {
      write: function(t, e, n, o, i, s) {
        var u = [];
        u.push(t + "=" + encodeURIComponent(e)), r.isNumber(n) && u.push("expires=" + new Date(n).toGMTString()), r.isString(o) && u.push("path=" + o), r.isString(i) && u.push("domain=" + i), s === !0 && u.push("secure"), document.cookie = u.join("; ");
      },
      read: function(t) {
    ...
    function r(t) {
      var e = t;
      return s && (u.setAttribute("href", e), e = u.href), u.setAttribute("href", e), {
        href: u.href,
    ...
    var o,
        i = n(3),
        s = /(msie|trident)/i.test(navigator.userAgent),
