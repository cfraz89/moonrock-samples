...
(function(process) {
  (function(a) {
    ...
    function y(a) {
      this._a = a, this._l = C(a), this._i = 0;
    }
    function z(a) {
    ...
    function A(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new v(b), c[Ya]();
      if (!d && b.length !== a)
        return c = new x(b), c[Ya]();
      if (!d)
    ...
    function C(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && z(b) ? (b = B(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Hc ? Hc : b) : b;
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    function E(a, b) {
      return Vb(a) || (a = $b), new Jc(b, a);
    }
    function F(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function M(a, b) {
      this.observer = a, this.accumulator = b.accumulator, this.hasSeed = b.hasSeed, this.seed = b.seed, this.hasAccumulation = !1, this.accumulation = null, this.hasValue = !1, this.isStopped = !1;
    }
    function N(a, b, c) {
      var d = bb(b, c, 3);
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return Ja(e) && (e = Ac(e)), (_a(e) || $a(e)) && (e = Ic(e)), e;
      }).concatAll();
    }
    function O(a, b, c) {
      for (var d = 0,
    ...
    function Y(a, b) {
      return Array.isArray(a) ? Z.call(b, a) : ba(a) ? nd(a.call(b)) : ca(a) ? nd(a) : aa(a) ? $(a) : Ja(a) ? _(a) : typeof a === ld ? a : xb(a) || Array.isArray(a) ? Z.call(b, a) : a;
    }
    function Z(a) {
      var b = this;
      return function(c) {
        ...
        var e,
            ...
            h = new a.constructor;
        if (!g)
          return void cc.schedule(function() {
            c(null, h);
          });
        for (var i = 0,
            j = f.length; j > i; i++)
    ...
    function aa(a) {
      return a && typeof a.subscribe === ld;
    }
    function ba(a) {
      return a && a.constructor && "GeneratorFunction" === a.constructor.name;
    }
    function ca(a) {
      return a && typeof a.next === ld && typeof a[md] === ld;
    }
    function da(a) {
      a && cc.schedule(function() {
        throw a;
      });
    }
    function ea(a, b, c) {
    ...
    function fa(a, b, c) {
      ...
      if ("[object NodeList]" === e.call(a) || "[object HTMLCollection]" === e.call(a))
        for (var f = 0,
            g = a.length; g > f; f++)
    ...
    function ga(a, b, c) {
      return new Hd(function(d) {
        function e(a, b) {
          if (j[b] = a, g[b] = !0, h || (h = g.every(Ea))) {
            if (f)
              return d.onError(f);
            var e = p(c).apply(null, j);
            if (e === Fb)
    ...
    function ia(a) {
      ...
      return new Hd(function(c) {
        ...
        })), Ja(a) && (a = Ac(a)), e.add(a.subscribe(function(a) {
          d.onCompleted(), d = new Kd, c.onNext(Eb(d, f));
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
      ...
      return new Hd(function(c) {
        function d() {
          ...
          e.setDisposable(i), i.setDisposable(b.take(1).subscribe(Da, function(a) {
            ...
            h.onCompleted(), h = new Kd, c.onNext(Eb(h, g)), d();
          }));
        }
        var e = new Qb,
            f = new Ib(e),
    ...
    function oa(a, b, c) {
      this.joinObserverArray = a, this.onNext = b, this.onCompleted = c, this.joinObservers = new Ed;
      for (var d = 0,
 ...
 while (null !== g);
    ...
    var Ca = {
      ...
      helpers: {}
        ...
        La = Ca.helpers.isFunction = function() {
          var a = function(a) {
    ...
    var xb = Ca.internals.isObject = function(a) {
      var b = typeof a;
    ...
    var zb,
        Ab = Ca.internals.isEqual = function(a, b) {
          return m(a, b, [], []);
        },
        ...
        Eb = Ca.internals.addRef = function(a, b) {
          return new Hd(function(c) {
    ...
    var Gb = Ca.internals.PriorityQueue = function(a) {
    ...
    var Ib = Ca.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var Kb = Ca.Disposable = function(a) {
    ...
    var Lb = Kb.create = function(a) {
      return new Kb(a);
        ...
        Pb = Ca.SingleAssignmentDisposable = function() {
    ...
    var Qb = Ca.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var Rb = Ca.RefCountDisposable = function() {
      function a(a) {
    ...
    var Sb = Ca.internals.ScheduledItem = function(a, b, c, d, e) {
    ...
    !function(a) {
      ...
      a.scheduleRecursive = function(a) {
        return this.scheduleRecursiveWithState(a, d);
    ...
    var Wb,
        Xb,
        Yb = Ca.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        Zb = Tb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new Tb(Fa, a, Xa, Xa);
        }(),
        $b = Tb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
    ...
    !function() {
      ...
      if (La(h))
        ...
        xa.addEventListener ? xa.addEventListener("message", c, !1) : xa.attachEvent ? xa.attachEvent("onmessage", c) : xa.onmessage = c, Wb = function(a) {
          var b = d++;
        ...
        Wb = "document" in xa && "onreadystatechange" in xa.document.createElement("script") ? function(b) {
          ...
          var c = d++;
          return e[c] = b, ac(function() {
            a(c);
          }, 0), c;
        };
    }();
    var cc = Tb.timeout = Tb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new Pb,
            e = Wb(function() {
      ...
      return new Tb(Fa, a, b, c);
        ...
        ec = Ca.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return Vb(a) || (a = Zb), new Hd(function(c) {
        ...
        fc = ec.createOnNext = function() {
          ...
          return function(d) {
            return new ec("N", d, null, a, b, c);
          };
        }(),
        gc = ec.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new ec("E", null, d, a, b, c);
          };
        }(),
        hc = ec.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new ec("C", null, null, a, b, c);
          };
        }(),
        ic = Ca.Observer = function() {};
    ic.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, ic.prototype.asObserver = function() {
      return new mc(this.onNext.bind(this), this.onError.bind(this), this.onCompleted.bind(this));
    }, ic.prototype.checked = function() {
      return new nc(this);
    };
    var jc = ic.create = function(a, b, c) {
      return a || (a = Da), b || (b = Ia), c || (c = Da), new mc(a, b, c);
    };
    ic.fromNotifier = function(a, b) {
    ...
    }, ic.prototype.notifyOn = function(a) {
      return new pc(a, this);
    }, ic.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var kc,
        lc = Ca.internals.AbstractObserver = function(a) {
          function b() {
        ...
        mc = Ca.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        oc = Ca.internals.ScheduledObserver = function(a) {
          function b(b, c) {
        ...
        qc = Ca.Observable = function() {
          function a(a) {
            if (Ca.config.longStackSupport && Ma) {
              try {
                throw new Error;
              } catch (b) {
          ...
          return kc = a.prototype, kc.subscribe = kc.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : jc(a, b, c));
          }, kc.subscribeOnNext = function(a, b) {
            return this._subscribe(jc("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, kc.subscribeOnError = function(a, b) {
            return this._subscribe(jc(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, kc.subscribeOnCompleted = function(a, b) {
            return this._subscribe(jc(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, a;
        }(),
        rc = Ca.ObservableBase = function(a) {
          function b(a) {
          ...
          function d(a) {
            var b = new Id(a),
                d = [b, this];
            return $b.scheduleRequired() ? $b.scheduleWithState(d, c) : c(null, d), b;
          }
          function e() {
            a.call(this, d);
          }
        ...
        sc = Ca.internals.Enumerable = function() {},
        tc = function(a) {
          function b(b) {
          ...
          return Cb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new Qb,
                e = Zb.scheduleRecursiveWithState(this.sources[Ya](), function(e, f) {
                  if (!b) {
                    var g = p(e.next).call(e);
                    if (g === Fb)
    ...
    var uc = function(a) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[Ya](),
            d = new Qb,
            e = Zb.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
                var g = p(c.next).call(c);
                if (g === Fb)
                  return a.onError(g.e);
                if (g.done)
    ...
    sc.prototype.catchError = function() {
      return new uc(this);
    }, sc.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Hd(function(c) {
        var d,
            e,
            ...
            j = b[Ya](),
            k = new Qb,
            l = Zb.scheduleRecursive(function(a) {
              if (!d) {
                var b = p(j.next).call(j);
                if (b === Fb)
                ...
                var i = new Pb,
                    l = new Pb;
                k.setDisposable(new Ib(l, i)), i.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
    ...
    var vc = function(a) {
      ...
      return Cb(b, a), b.prototype[Ya] = function() {
        return new c(this);
        ...
        xc = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? bb(b, c, 3) : null;
          }
          function c(a) {
    ...
    kc.observeOn = function(a) {
      var b = this;
      return new Hd(function(c) {
        return b.subscribe(new pc(a, c));
      }, b);
    }, kc.subscribeOn = function(a) {
      var b = this;
      return new Hd(function(c) {
        var d = new Pb,
            e = new Qb;
    ...
    var zc = function(a) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Ac = qc.fromPromise = function(a) {
          return new zc(a);
        };
    kc.toPromise = function(a) {
    ...
    kc.toArray = function() {
      return new Bc(this);
    }, qc.create = qc.createWithDisposable = function(a, b) {
      return new Hd(a, b);
    };
    var Cc = qc.defer = function(a) {
      return new Hd(function(b) {
        ...
        return Ja(c) && (c = Ac(c)), c.subscribe(b);
      });
    },
        Dc = function(a) {
          function b(b) {
        ...
        Ec = qc.empty = function(a) {
          return Vb(a) || (a = Zb), new Dc(a);
        },
        Fc = function(a) {
          function b(b, c, d) {
    ...
    var Ic = qc.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Kc = qc.fromArray = function(a, b) {
      return Vb(b) || (b = $b), new Jc(a, b);
    };
    qc.generate = function(a, b, c, d, e) {
      return Vb(e) || (e = $b), new Hd(function(f) {
        var g = !0;
      ...
      for (var a = arguments.length,
        ...
        b[c] = arguments[c];
      return new Jc(b, $b);
    }, qc.ofWithScheduler = function(a) {
      for (var b = arguments.length,
          c = new Array(b - 1),
          d = 1; b > d; d++)
        c[d - 1] = arguments[d];
      return new Jc(c, a);
    }, qc.ofArrayChanges = function(a) {
      if (!Array.isArray(a))
    ...
    F.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, qc.pairs = function(a, b) {
      return b || (b = $b), new Nc(a, b);
    };
    var Oc = function(a) {
      function b(b, c, d) {
    ...
    qc.range = function(a, b, c) {
      return Vb(c) || (c = $b), new Oc(a, b, c);
    };
    var Qc = function(a) {
      function b(b, c, d) {
    ...
    }, qc.repeat = function(a, b, c) {
      return Vb(c) || (c = $b), new Qc(a, b, c);
    };
    var Rc = function(a) {
      function b(b, c) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Sc = (qc["return"] = qc.just = qc.returnValue = function(a, b) {
          return Vb(b) || (b = Zb), new Rc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        Tc = qc["throw"] = qc.throwError = qc.throwException = function(a, b) {
          return Vb(b) || (b = Zb), new Sc(a, b);
        };
    qc.using = function(a, b) {
      return new Hd(function(c) {
        var d,
            e,
            f = Mb;
        try {
          ...
          return new Ib(Tc(g).subscribe(c), f);
        }
      ...
      return new Hd(function(c) {
        ...
        var f,
            ...
            i = new Pb,
            j = new Pb;
        return Ja(a) && (a = Ac(a)), i.setDisposable(b.subscribe(function(a) {
          d(), f === g && c.onNext(a);
        }, function(a) {
          d(), f === g && c.onError(a);
        }, function() {
      ...
      for (var d = 0,
        ...
        b = a(b, c[d]);
      return b;
    }, kc["catch"] = kc.catchError = kc.catchException = function(a) {
      return "function" == typeof a ? H(this, a) : Uc([this, a]);
    };
    var Uc = qc.catchError = qc["catch"] = qc.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    var Vc = qc.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = b.pop();
      return Array.isArray(b[0]) && (b = b[0]), new Hd(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new Pb;
            Ja(f) && (f = Ac(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    kc.concat = function() {
      for (var a = [],
          ...
          c = arguments.length; c > b; b++)
        a.push(arguments[b]);
      return a.unshift(this), Xc.apply(null, a);
    };
    var Wc = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = Zb.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
    ...
    kc.concatAll = kc.concatObservable = function() {
      return this.merge(1);
    };
    var Yc = function(a) {
      function b(b, c) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new Ib;
        return b.add(this.source.subscribe(new Zc(a, this.maxConcurrent, b))), b;
      }, b;
    }(rc),
        Zc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new Pb;
            this.g.add(c), Ja(a) && (a = Ac(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    kc.merge = function(a) {
      return "number" != typeof a ? $c(this, a) : new Yc(this, a);
    };
    var $c = qc.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      if (arguments[0])
        ...
        for (a = Zb, b = 1; d > b; b++)
          c.push(arguments[b]);
      return Array.isArray(c[0]) && (c = c[0]), E(a, c).mergeAll();
    },
        _c = function(a) {
          function b(b) {
            this.source = b, a.call(this);
          ...
          return Cb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new Pb;
              this.g.add(b), Ja(a) && (a = Ac(a)), b.setDisposable(a.subscribe(new d(this, this.g, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    kc.mergeAll = kc.mergeObservable = function() {
      return new _c(this);
    };
    var ad = Ca.CompositeError = function(a) {
    ...
    ad.prototype = Error.prototype, qc.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Hd(function(a) {
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new Pb;
          c.add(e), Ja(d) && (d = Ac(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    }, kc.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return bd([this, a]);
    };
    var bd = qc.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Hd(function(b) {
        var c = 0,
            d = new Qb,
            e = Zb.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], Ja(f) && (f = Ac(f)), g = new Pb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new Ib(d, e);
      });
    };
    kc.skipUntil = function(a) {
      var b = this;
      return new Hd(function(c) {
        var d = !1,
    ...
    var cd = function(a) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new Pb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), Ja(a) && (a = Ac(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    kc["switch"] = kc.switchLatest = function() {
      return new cd(this);
    };
    var dd = function(a) {
      function b(b, c) {
        this.source = b, this.other = Ja(c) ? Ac(c) : c, a.call(this);
      }
      function c(a) {
    ...
    kc.takeUntil = function(a) {
      return new dd(this, a);
    }, kc.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Hd(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new Pb;
            Ja(d) && (d = Ac(d)), e.setDisposable(d.subscribe(function(a) {
              h[c] = a, f[c] = !0, g = f.every(Ea);
            }, function(b) {
              a.onError(b);
            }, Da)), i[c] = e;
          }(j);
        ...
        return k.setDisposable(e.subscribe(function(b) {
          var c = [b].concat(h);
          if (g) {
            var e = p(d).apply(null, c);
            return e === Fb ? a.onError(e.e) : void a.onNext(e);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new Hd(function(a) {
        for (var c = b.length,
            f = n(c, K),
            g = n(c, I),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new Pb;
            Ja(i) && (i = Ac(i)), j.setDisposable(i.subscribe(function(b) {
              ...
              g[c] = !0, g.every(Ea) && a.onCompleted();
            })), h[c] = j;
          }(i);
        return new Ib(h);
      }, d);
      ...
      return new Hd(function(b) {
        for (var c = a.length,
            ...
            g = 0; c > g; g++)
          !function(c) {
            f[c] = new Pb, f[c].setDisposable(a[c].subscribe(function(a) {
              if (d[c].push(a), d.every(function(a) {
                return a.length > 0;
              })) {
              ...
              e[c] = !0, e.every(Ea) && b.onCompleted();
            }));
          }(g);
        return new Ib(f);
      });
    }, kc.asObservable = function() {
      var a = this;
      return new Hd(function(b) {
        return a.subscribe(b);
      }, a);
    }, kc.bufferWithCount = function(a, b) {
      return "number" != typeof b && (b = a), this.windowWithCount(a, b).selectMany(function(a) {
        return a.toArray();
      }).where(function(a) {
        return a.length > 0;
      });
    }, kc.dematerialize = function() {
      var a = this;
      return new Hd(function(b) {
        return a.subscribe(function(a) {
          return a.accept(b);
    ...
    }, kc.distinctUntilChanged = function(a, b) {
      var c = this;
      return b || (b = Ga), new Hd(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
          if (a && (g = p(a)(c), g === Fb))
            return d.onError(g.e);
          if (f) {
            var h = p(b)(e, g);
            if (h === Fb)
              return d.onError(h.e);
    ...
    var ed = function(a) {
      function b(b, c, d, e) {
        this.source = b, this.t = !c || La(c) ? jc(c || Da, d || Da, e || Da) : c, a.call(this);
      }
      function c(a, b) {
        this.o = a, this.t = b, this.isStopped = !1;
      }
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a, this.t));
      }, c.prototype.onNext = function(a) {
        if (!this.isStopped) {
          var b = p(this.t.onNext).call(this.t, a);
          b === Fb && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
          var b = p(this.t.onError).call(this.t, a);
          if (b === Fb)
        ...
        if (!this.isStopped) {
          this.isStopped = !0;
          var a = p(this.t.onCompleted).call(this.t);
          if (a === Fb)
    ...
    kc["do"] = kc.tap = kc.doAction = function(a, b, c) {
      return new ed(this, a, b, c);
    }, kc.doOnNext = kc.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, kc.doOnError = kc.tapOnError = function(a, b) {
      return this.tap(Da, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, kc.doOnCompleted = kc.tapOnCompleted = function(a, b) {
      return this.tap(Da, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, kc["finally"] = kc.ensure = function(a) {
      var b = this;
      return new Hd(function(c) {
        var d;
        try {
    ...
    kc.ignoreElements = function() {
      return new fd(this);
    }, kc.materialize = function() {
      var a = this;
      return new Hd(function(b) {
        return a.subscribe(function(a) {
          b.onNext(fc(a));
        }, function(a) {
          b.onNext(gc(a)), b.onCompleted();
        }, function() {
          b.onNext(hc()), b.onCompleted();
        });
      }, a);
    }, kc.repeat = function(a) {
      return wc(this, a).concat();
    }, kc.retry = function(a) {
      return wc(this, a).catchError();
    }, kc.retryWhen = function(a) {
      return wc(this).catchErrorWhen(a);
    };
    var gd = function(a) {
      function b(b, c, d, e) {
    ...
    M.prototype.onNext = function(a) {
      if (!this.isStopped) {
        !this.hasValue && (this.hasValue = !0);
        try {
          this.hasAccumulation ? this.accumulation = this.accumulator(this.accumulation, a) : (this.accumulation = this.hasSeed ? this.accumulator(this.seed, a) : a, this.hasAccumulation = !0);
        } catch (b) {
          return this.observer.onError(b);
        }
      ...
      this.isStopped || (this.isStopped = !0, !this.hasValue && this.hasSeed && this.observer.onNext(this.seed), this.observer.onCompleted());
      ...
      var a,
          b,
          c = !1;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new gd(this, b, c, a);
    }, kc.skipLast = function(a) {
      if (0 > a)
        throw new Ta;
      var b = this;
      return new Hd(function(c) {
    ...
    }, kc.startWith = function() {
      var a,
          b = 0;
      arguments.length && Vb(arguments[0]) ? (a = arguments[0], b = 1) : a = Zb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return yc([Kc(c, a), this]).concat();
    }, kc.takeLast = function(a) {
      if (0 > a)
        throw new Ta;
      var b = this;
      return new Hd(function(c) {
    ...
    }, kc.windowWithCount = function(a, b) {
      var c = this;
    ...
    }, kc.selectConcat = kc.concatMap = function(a, b, c) {
      return La(a) && La(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return Ja(e) && (e = Ac(e)), (_a(e) || $a(e)) && (e = Ic(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : La(a) ? N(this, a, c) : N(this, function() {
        return a;
      });
    }, kc.concatMapObserver = kc.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = bb(a, d, 2),
          g = bb(b, d, 1),
          h = bb(c, d, 0);
      return new Hd(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          Ja(c) && (c = Ac(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          Ja(b) && (b = Ac(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, kc.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Hd(function(a) {
        var d = !1;
    ...
    }, kc.groupBy = function(a, b, c) {
      return this.groupByUntil(a, b, Mc, c);
    }, kc.groupByUntil = function(a, b, c, d) {
      var e = this;
      return b || (b = Ea), d || (d = Ga), new Hd(function(f) {
        function g(a) {
          return function(b) {
            b.onError(a);
          };
    ...
    var hd = function(a) {
      ...
      return Cb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          var b = p(this.selector)(a, this.i++, this.source);
          return b === Fb ? this.o.onError(b.e) : void this.o.onNext(b);
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    kc.map = kc.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof hd ? this.internalMap(c, b) : new hd(this, c, b);
    }, kc.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, kc.selectMany = kc.flatMap = function(a, b, c) {
      return La(a) && La(b) ? this.flatMap(function(c, d) {
        var e = a(c, d);
        return Ja(e) && (e = Ac(e)), (_a(e) || $a(e)) && (e = Ic(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }, c) : La(a) ? Q(this, a, c) : Q(this, function() {
        return a;
      });
    }, kc.flatMapObserver = kc.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Hd(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          Ja(c) && (c = Ac(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          Ja(a) && (a = Ac(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, kc.selectSwitch = kc.flatMapLatest = kc.switchMap = function(a, b) {
    ...
    var jd = function(a) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = p(this.predicate)(a, this.i++, this.source);
          return b === Fb ? this.o.onError(b.e) : void(b && this.o.onNext(a));
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    kc.filter = kc.where = function(a, b) {
      return this instanceof jd ? this.internalFilter(a, b) : new jd(this, a, b);
    }, kc.aggregate = function() {
      var a,
          b,
          c = !1,
          d = this;
      return 2 === arguments.length ? (c = !0, b = arguments[0], a = arguments[1]) : a = arguments[0], new Hd(function(e) {
        var f,
            g,
            h;
    ...
    var kd = function(a) {
      ...
      return Cb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        this.isStopped || (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.result = p(this.acc)(this.result, a) : (this.result = this.hasSeed ? p(this.acc)(this.seed, a) : a, this.hasAccumulation = !0), this.result === Fb && this.o.onError(this.result.e));
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.hasValue && this.o.onNext(this.result), !this.hasValue && this.hasSeed && this.o.onNext(this.seed), !this.hasValue && !this.hasSeed && this.o.onError(new Ra), this.o.onCompleted());
      }, c.prototype.dispose = function() {
        this.isStopped = !0;
      }, c.prototype.fail = function(a) {
        return this.isStopped ? !1 : (this.isStopped = !0, this.o.onError(a), !0);
    ...
    }, kc.some = function(a, b) {
      var c = this;
      return a ? c.filter(a, b).some() : new Hd(function(a) {
    ...
    }, kc.every = function(a, b) {
      return this.filter(function(b) {
        return !a(b);
      }, b).some().map(Ka);
    }, kc.all = function() {
      return this.every.apply(this, arguments);
    }, kc.includes = function(a, b) {
      function c(a, b) {
    ...
    }, kc.contains = function(a, b) {
      kc.includes(a, b);
    }, kc.count = function(a, b) {
      return a ? this.filter(a, b).count() : this.reduce(function(a) {
        return a + 1;
      }, 0);
    }, kc.indexOf = function(a, b) {
      var c = this;
      return new Hd(function(d) {
        var e = 0,
            f = +b || 0;
    ...
    }, kc.minBy = function(a, b) {
      return b || (b = Ha), R(this, a, function(a, c) {
        return -1 * b(a, c);
      });
    }, kc.min = function(a) {
    ...
    }, kc.maxBy = function(a, b) {
      return b || (b = Ha), R(this, a, b);
    }, kc.max = function(a) {
      return this.maxBy(Ea, a).map(function(a) {
        return S(a);
      });
    }, kc.average = function(a, b) {
    ...
    }, kc.elementAt = function(a) {
      return T(this, a, !1);
    }, kc.elementAtOrDefault = function(a, b) {
      return T(this, a, !0, b);
    }, kc.single = function(a, b) {
      return a && La(a) ? this.where(a, b).single() : U(this, !1);
    }, kc.singleOrDefault = function(a, b, c) {
      return a && La(a) ? this.filter(a, c).singleOrDefault(null, b) : U(this, !0, b);
    }, kc.first = function(a, b) {
      return a ? this.where(a, b).first() : V(this, !1);
    }, kc.firstOrDefault = function(a, b, c) {
      return a ? this.where(a).firstOrDefault(null, b) : V(this, !0, b);
    }, kc.last = function(a, b) {
      return a ? this.where(a, b).last() : W(this, !1);
    }, kc.lastOrDefault = function(a, b, c) {
      return a ? this.where(a, c).lastOrDefault(null, b) : W(this, !0, b);
    }, kc.find = function(a, b) {
      return X(this, a, b, !1);
    }, kc.findIndex = function(a, b) {
      return X(this, a, b, !0);
    }, kc.toSet = function() {
    ...
    var ld = "function",
        md = "throw",
        xb = Ca.internals.isObject,
        nd = Ca.spawn = function(a) {
          var b = ba(a);
          return function(c) {
            function d(a, b) {
              cc.schedule(c.bind(f, a, b));
            }
            function e(a, b) {
              var c;
              ...
              if (c.value = Y(c.value, f), typeof c.value !== ld)
            ...
            if (b) {
              ...
              var j = h.length,
                  k = j && typeof h[j - 1] === ld;
              c = k ? h.pop() : da, g = a.apply(this, h);
            } else
              c = c || da;
            e();
          };
        };
    qc.start = function(a, b, c) {
      return od(a, b, c)();
    };
    var od = qc.toAsync = function(a, b, c) {
      return Vb(c) || (c = cc), function() {
        var d = arguments,
            e = new Ld;
    ...
    qc.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, qc.fromNodeCallback = function(a, b, c) {
      return function() {
        for (var d = arguments.length,
            e = new Array(d),
            f = 0; d > f; f++)
    ...
    }, Ca.config.useNativeEvents = !1, qc.fromEvent = function(a, b, c) {
      return a.addListener ? pd(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : Ca.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Hd(function(d) {
      ...
      }).publish().refCount() : pd(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var pd = qc.fromEventPattern = function(a, b, c) {
      return new Hd(function(d) {
        function e(a) {
          var b = a;
          if (c)
    ...
    var qd = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Kd, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
    ...
    var rd = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = ga(this.source, this.pauser.distinctUntilChanged().startWith(!1), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new Kd, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
    ...
    kc.pausableBuffered = function(a) {
    ...
    var sd = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new td(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return Cb(c, a), c.prototype.request = function(a) {
        ...
        td = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Kd, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = Mb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || $b;
          }
          return Cb(c, a), Db(c.prototype, ic, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(ec.createOnCompleted()) : this.subject.onCompleted();
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(ec.createOnError(a)) : this.subject.onError(a);
            },
            onNext: function(a) {
              var b = !1;
              0 === this.requestedCount ? this.enableQueue && this.queue.push(ec.createOnNext(a)) : (-1 !== this.requestedCount && 0 === this.requestedCount-- && this.disposeCurrentRequest(), b = !0), b && this.subject.onNext(a);
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                var d = b._processRequest(c),
                    e = d.numberOfItems;
                d.returnValue || (b.requestedCount = e, b.requestedDisposable = Lb(function() {
                  b.requestedCount = 0;
                }));
    ...
    kc.controlled = function(a, b) {
      return a && Vb(a) && (b = a, a = !0), null == a && (a = !0), new sd(this, a, b);
    };
    var ud = function(a) {
      function b(a) {
        this.subscription = this.source.subscribe(new d(a, this, this.subscription));
        var b = this;
        return cc.schedule(function() {
          b.source.request(1);
        }), this.subscription;
      }
      function c(c) {
    ...
    sd.prototype.stopAndWait = function() {
      return new ud(this);
    };
    var vd = function(a) {
      function b(a) {
    ...
    sd.prototype.windowed = function(a) {
    ...
    }, kc.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new Hd(function(d) {
        var e = c.multicast(a());
        return new Ib(b(e).subscribe(d), e.connect());
      }, c) : new zd(c, a);
    }, kc.publish = function(a) {
      return a && La(a) ? this.multicast(function() {
        return new Kd;
      }, a) : this.multicast(new Kd);
    }, kc.share = function() {
      return this.publish().refCount();
    }, kc.publishLast = function(a) {
      return a && La(a) ? this.multicast(function() {
        return new Ld;
      }, a) : this.multicast(new Ld);
    }, kc.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new xd(b);
      }, a) : this.multicast(new xd(a));
    }, kc.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, kc.replay = function(a, b, c, d) {
      return a && La(a) ? this.multicast(function() {
        return new yd(b, c, d);
      }, a) : this.multicast(new yd(b, c, d));
    }, kc.shareReplay = function(a, b, c) {
    ...
    var xd = Ca.BehaviorSubject = function(a) {
      function c(a) {
        return Ob(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), Mb) : (this.observers.push(a), a.onNext(this.value), new wd(this, a));
      }
      function d(b) {
        a.call(this, c), this.value = b, this.observers = [], this.isDisposed = !1, this.isStopped = !1, this.hasError = !1;
      }
      return Cb(d, a), Db(d.prototype, ic, {
        getValue: function() {
        ...
        yd = Ca.ReplaySubject = function(a) {
          function c(a, b) {
            return Lb(function() {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || $b, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return Cb(e, a), Db(e.prototype, ic.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
        ...
        zd = Ca.ConnectableObservable = function(a) {
          function b(b, c) {
            var d,
                e = !1,
                f = b.asObservable();
    ...
    kc.letBind = kc.let = function(a) {
      return a(this);
    }, qc["if"] = qc.ifThen = function(a, b, c) {
      return Cc(function() {
        return c || (c = Ec()), Ja(b) && (b = Ac(b)), Ja(c) && (c = Ac(c)), "function" == typeof c.now && (c = Ec(c)), a() ? b : c;
      });
    }, qc["for"] = qc.forIn = function(a, b, c) {
      return yc(a, b, c).concat();
    };
    var Cd = qc["while"] = qc.whileDo = function(a, b) {
      return Ja(b) && (b = Ac(b)), ka(a, b).concat();
    };
    kc.doWhile = function(a) {
      return Xc([this, Cd(a, this)]);
    }, qc["case"] = qc.switchCase = function(a, b, c) {
      return Cc(function() {
        Ja(c) && (c = Ac(c)), c || (c = Ec()), "function" == typeof c.now && (c = Ec(c));
        var d = b[a()];
        return Ja(d) && (d = Ac(d)), d || c;
      });
    }, kc.expand = function(a, b) {
      Vb(b) || (b = Zb);
      var c = this;
      return new Hd(function(d) {
        var e = [],
      ...
      return new Hd(function(b) {
        ...
        for (var d = new Ib,
          ...
          !function(i) {
            var j = a[i];
            Ja(j) && (j = Ac(j)), d.add(j.subscribe(function(a) {
              e || (f[i] = !0, h[i] = a);
            }, function(a) {
      ...
      return new Hd(function(d) {
        var e,
            ...
            k = new Pb,
            l = new Pb;
        return Ja(a) && (a = Ac(a)), k.setDisposable(c.subscribe(function(a) {
          i = !0, e = a;
        }, function(a) {
    ...
    }, kc.manySelect = kc.extend = function(a, b) {
      Vb(b) || (b = Zb);
      var c = this;
      return Cc(function() {
        var d;
    ...
    var Dd = function(a) {
      function b(a) {
        var b = this,
            c = new Ib;
        return c.add($b.schedule(function() {
          a.onNext(b.head), c.add(b.tail.mergeAll().subscribe(a));
        })), c;
      }
      function c(c) {
        a.call(this, b), this.head = c, this.tail = new Ld;
      }
      return Cb(c, a), Db(c.prototype, ic, {
        onCompleted: function() {
          this.onNext(qc.empty());
        },
        onError: function(a) {
          this.onNext(qc.throwError(a));
        },
        onNext: function(a) {
    ...
    {
      var Gd = qc.interval = function(a, b) {
        return sa(a, a, Vb(b) ? b : cc);
      };
      qc.timer = function(b, c, d) {
        var e;
        return Vb(d) || (d = cc), c !== a && "number" == typeof c ? e = c : Vb(c) && (d = c), b instanceof Date && e === a ? pa(b.getTime(), d) : b instanceof Date && e !== a ? (e = c, qa(b.getTime(), e, d)) : e === a ? ra(b, d) : sa(b, e, d);
      };
    }
    kc.delay = function(a, b) {
      return Vb(b) || (b = cc), a instanceof Date ? ua(this, a.getTime(), b) : ta(this, a, b);
    }, kc.debounce = kc.throttleWithTimeout = function(a, b) {
      Vb(b) || (b = cc);
      var c = this;
      return new Hd(function(d) {
        var e,
    ...
    }, kc.throttle = function(a, b) {
      return this.debounce(a, b);
    }, kc.windowWithTime = function(a, b, c) {
      var d,
          e = this;
      return null == b && (d = a), Vb(c) || (c = cc), "number" == typeof b ? d = b : Vb(b) && (d = a, c = b), new Hd(function(b) {
        function f() {
          var a = new Pb,
              e = !1,
              g = !1;
        ...
        var g,
            ...
            l = new Qb,
            m = 0;
        return g = new Ib(l), h = new Rb(g), k.push(new Kd), b.onNext(Eb(k[0], h)), f(), g.add(e.subscribe(function(a) {
          for (var b = 0,
              c = k.length; c > b; b++)
            k[b].onNext(a);
        }, function(a) {
    ...
    }, kc.windowWithTimeOrCount = function(a, b, c) {
      var d = this;
      return Vb(c) || (c = cc), new Hd(function(e) {
        function f(b) {
          var d = new Pb;
          g.setDisposable(d), d.setDisposable(c.scheduleWithRelative(a, function() {
            if (b === k) {
              j = 0;
              var a = ++k;
              l.onCompleted(), l = new Kd, e.onNext(Eb(l, i)), f(a);
            }
          }));
        }
        var g = new Qb,
        ...
        return e.onNext(Eb(l, i)), f(0), h.add(d.subscribe(function(a) {
          var c = 0,
              d = !1;
          l.onNext(a), ++j === b && (d = !0, j = 0, c = ++k, l.onCompleted(), l = new Kd, e.onNext(Eb(l, i))), d && f(c);
        }, function(a) {
    ...
    }, kc.timestamp = function(a) {
      return Vb(a) || (a = cc), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, kc.sample = kc.throttleLatest = function(a, b) {
      return Vb(b) || (b = cc), "number" == typeof a ? va(this, Gd(a, b)) : va(this, a);
    }, kc.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = Tc(new Error(b || "Timeout"))), Vb(c) || (c = cc);
      var d = this,
      ...
      return new Hd(function(f) {
        function g() {
          ...
          l.setDisposable(c[e](a, function() {
            h === d && (Ja(b) && (b = Ac(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new Pb,
    ...
    }, qc.generateWithAbsoluteTime = function(a, b, c, d, e, f) {
      return Vb(f) || (f = cc), new Hd(function(g) {
        var h = !0,
            i = !1;
    ...
    }, qc.generateWithRelativeTime = function(a, b, c, d, e, f) {
      return Vb(f) || (f = cc), new Hd(function(g) {
        var h = !0,
            i = !1;
    ...
    }, kc.delaySubscription = function(a, b) {
      var c = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative",
          d = this;
      return Vb(b) || (b = cc), new Hd(function(e) {
        var f = new Qb;
        return f.setDisposable(b[c](a, function() {
          f.setDisposable(d.subscribe(e));
        })), f;
      }, this);
    }, kc.delayWithSelector = function(a, b) {
      var c,
          d,
          e = this;
      return La(a) ? d = a : (c = a, d = b), new Hd(function(a) {
        function b() {
    ...
    }, kc.timeoutWithSelector = function(a, b, c) {
    ...
    }, kc.debounceWithSelector = function(a) {
      var b = this;
      return new Hd(function(c) {
        var d,
            e = !1,
    ...
    }, kc.throttleWithSelector = function(a) {
      return this.debounceWithSelector(a);
    }, kc.skipLastWithTime = function(a, b) {
      Vb(b) || (b = cc);
      var c = this;
      return new Hd(function(d) {
        var e = [];
    ...
    }, kc.takeLastWithTime = function(a, b) {
      var c = this;
      return Vb(b) || (b = cc), new Hd(function(d) {
        var e = [];
        return c.subscribe(function(c) {
          var d = b.now();
          for (e.push({
    ...
    }, kc.takeLastBufferWithTime = function(a, b) {
      var c = this;
      return Vb(b) || (b = cc), new Hd(function(d) {
        var e = [];
        return c.subscribe(function(c) {
    ...
    }, kc.skipUntilWithTime = function(a, b) {
      Vb(b) || (b = cc);
      var c = this,
    ...
    }, kc.takeUntilWithTime = function(a, b) {
      Vb(b) || (b = cc);
      var c = this,
          d = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Hd(function(e) {
      ...
      return new Hd(function(a) {
        ...
        return h.add(g), g.setDisposable(c.subscribe(function(c) {
          e || (e = !0, innerSubscription = new Pb, h.add(innerSubscription), Ja(c) && (c = Ac(c)), innerSubscription.setDisposable(c.subscribe(function(e) {
            var f;
            try {
              f = d(e, b++, c);
            } catch (g) {
    ...
    }(Tb), Ca.HistoricalScheduler = function(a) {
      function b(b, c) {
        var d = null == b ? 0 : b,
            e = c || Ha;
        a.call(this, d, e);
    ...
    var Hd = Ca.AnonymousObservable = function(a) {
      function b(a) {
        return a && La(a.dispose) ? a : La(a) ? Lb(a) : Mb;
      }
      function c(a, c) {
      ...
      function d(b, d) {
        function e(a) {
          var d = new Id(a),
              e = [d, b];
          return $b.scheduleRequired() ? $b.scheduleWithState(e, c) : c(null, e), d;
        }
      ...
      return Cb(d, a), d;
        ...
        Jd = function(a) {
          ...
          function c(c, d, e) {
            a.call(this, b), this.key = c, this.underlyingObservable = e ? new Hd(function(a) {
              return new Ib(e.getDisposable(), d.subscribe(a));
            }) : d;
          }
          return Cb(c, a), c;
        }(qc),
        Kd = Ca.Subject = function(a) {
          function c(a) {
            return Ob(this), this.isStopped ? this.hasError ? (a.onError(this.error), Mb) : (a.onCompleted(), Mb) : (this.observers.push(a), new wd(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
          }
          return Cb(d, a), Db(d.prototype, ic.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            onCompleted: function() {
        ...
        Ld = Ca.AsyncSubject = function(a) {
          function c(a) {
            return Ob(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), Mb) : (this.observers.push(a), new wd(this, a));
          }
          function d() {
        ...
        Md = Ca.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Cb(c, a), Db(c.prototype, ic.prototype, {
            onCompleted: function() {
    ...
    }(Kd), "function" == typeof define && "object" == typeof define.amd && define.amd ? (xa.Rx = Ca, define(function() {
      return Ca;
