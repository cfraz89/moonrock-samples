...
(function(process) {
  (function(a) {
    ...
    function A(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new v(b), c[$a]();
      if (!d && b.length !== a)
        return c = new x(b), c[$a]();
      if (!d)
    ...
    function C(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && z(b) ? (b = B(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Lc ? Lc : b) : b;
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    function E(a, b) {
      return Zb(a) || (a = cc), new Nc(b, a);
    }
    function F(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function N(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return La(e) && (e = Ec(e)), (bb(e) || ab(e)) && (e = Mc(e)), e;
      }).concatAll();
    }
    function O(a, b, c) {
      for (var d = 0,
    ...
    function Y(a, b) {
      return Array.isArray(a) ? Z.call(b, a) : ba(a) ? rd(a.call(b)) : ca(a) ? rd(a) : aa(a) ? $(a) : La(a) ? _(a) : typeof a === pd ? a : zb(a) || Array.isArray(a) ? Z.call(b, a) : a;
    }
    function Z(a) {
      var b = this;
      return function(c) {
    ...
    function aa(a) {
      return a && typeof a.subscribe === pd;
    }
    function ba(a) {
      return a && a.constructor && "GeneratorFunction" === a.constructor.name;
    }
    function ca(a) {
      return a && typeof a.next === pd && typeof a[qd] === pd;
    }
    function da(a) {
    ...
    function ha(a, b, c) {
      var d = new Mb;
      if (ea(a) || "[object HTMLCollection]" === Object.prototype.toString.call(a))
        for (var e = 0,
            f = a.length; f > e; e++)
    ...
    function ja(a, b) {
      return a.groupJoin(this, b, Ic, function(a, b) {
        return b;
      });
    }
    function ka(a) {
      ...
      return new Ld(function(c) {
        ...
        })), La(a) && (a = Ec(a)), e.add(a.subscribe(function(a) {
          d.onCompleted(), d = new Od, c.onNext(Gb(d, f));
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
      ...
      return new Ld(function(c) {
        function d() {
          ...
          e.setDisposable(i), i.setDisposable(b.take(1).subscribe(Fa, function(a) {
            ...
            h.onCompleted(), h = new Od, c.onNext(Gb(h, g)), d();
          }));
        }
        var e = new Ub,
            f = new Mb(e),
    ...
    function qa(a, b, c) {
      this.joinObserverArray = a, this.onNext = b, this.onCompleted = c, this.joinObservers = new Id;
      for (var d = 0,
 ...
 while (null !== g);
      ...
      return new Xb(Ha, a, b, c);
        ...
        ic = Ea.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return Zb(a) || (a = bc), new Ld(function(c) {
        ...
        mc = Ea.Observer = function() {};
    mc.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, mc.prototype.asObserver = function() {
      return new qc(this.onNext.bind(this), this.onError.bind(this), this.onCompleted.bind(this));
    }, mc.prototype.checked = function() {
      return new rc(this);
    };
    var nc = mc.create = function(a, b, c) {
      return a || (a = Fa), b || (b = Ka), c || (c = Fa), new qc(a, b, c);
    };
    mc.fromNotifier = function(a, b) {
    ...
    }, mc.prototype.notifyOn = function(a) {
      return new tc(a, this);
    }, mc.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var oc,
        pc = Ea.internals.AbstractObserver = function(a) {
          function b() {
        ...
        qc = Ea.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        sc = Ea.internals.ScheduledObserver = function(a) {
          function b(b, c) {
        ...
        uc = Ea.Observable = function() {
          ...
          return oc = a.prototype, oc.subscribe = oc.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : nc(a, b, c));
          }, oc.subscribeOnNext = function(a, b) {
            return this._subscribe(nc("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, oc.subscribeOnError = function(a, b) {
            return this._subscribe(nc(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, oc.subscribeOnCompleted = function(a, b) {
            return this._subscribe(nc(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, a;
        }(),
        vc = Ea.ObservableBase = function(a) {
          function b(a) {
        ...
        wc = Ea.internals.Enumerable = function() {},
        xc = function(a) {
          function b(b) {
          ...
          return Eb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new Ub,
                e = bc.scheduleRecursiveWithState(this.sources[$a](), function(e, f) {
                  if (!b) {
    ...
    var yc = function(a) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[$a](),
            d = new Ub,
            e = bc.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
    ...
    var zc = function(a) {
      ...
      return Eb(b, a), b.prototype[$a] = function() {
        return new c(this);
      }, c.prototype.next = function() {
        return 0 === this.l ? _a : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
        ...
        Bc = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? db(b, c, 3) : null;
          }
          function c(a) {
    ...
    oc.observeOn = function(a) {
      var b = this;
      return new Ld(function(c) {
        return b.subscribe(new tc(a, c));
      }, b);
    }, oc.subscribeOn = function(a) {
      var b = this;
      return new Ld(function(c) {
        var d = new Tb,
            e = new Ub;
    ...
    oc.toArray = function() {
      return new Fc(this);
    }, uc.create = uc.createWithDisposable = function(a, b) {
      return new Ld(a, b);
    };
    var Gc = uc.defer = function(a) {
      return new Ld(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return Xc(d).subscribe(b);
        }
        return La(c) && (c = Ec(c)), c.subscribe(b);
      });
    },
        Hc = function(a) {
          function b(b) {
        ...
        Ic = uc.empty = function(a) {
          return Zb(a) || (a = bc), new Hc(a);
        },
        Jc = function(a) {
          function b(b, c, d) {
    ...
    var Mc = uc.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Oc = uc.fromArray = function(a, b) {
      return Zb(b) || (b = cc), new Nc(a, b);
    };
    uc.generate = function(a, b, c, d, e) {
      return Zb(e) || (e = cc), new Ld(function(f) {
        var g = !0;
    ...
    F.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, uc.pairs = function(a, b) {
      return b || (b = cc), new Rc(a, b);
    };
    var Sc = function(a) {
      function b(b, c, d) {
    ...
    uc.range = function(a, b, c) {
      return Zb(c) || (c = cc), new Sc(a, b, c);
    };
    var Uc = function(a) {
      function b(b, c, d) {
    ...
    }, uc.repeat = function(a, b, c) {
      return Zb(c) || (c = cc), new Uc(a, b, c);
    };
    var Vc = function(a) {
      function b(b, c) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Wc = (uc["return"] = uc.just = uc.returnValue = function(a, b) {
          return Zb(b) || (b = bc), new Vc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        Xc = uc["throw"] = uc.throwError = uc.throwException = function(a, b) {
          return Zb(b) || (b = bc), new Wc(a, b);
        };
    uc.using = function(a, b) {
      return new Ld(function(c) {
        var d,
            e,
            f = Qb;
        try {
          ...
          return new Mb(Xc(g).subscribe(c), f);
        }
      ...
      return new Ld(function(c) {
        ...
        var f,
            ...
            i = new Tb,
            j = new Tb;
        return La(a) && (a = Ec(a)), i.setDisposable(b.subscribe(function(a) {
          d(), f === g && c.onNext(a);
        }, function(a) {
          d(), f === g && c.onError(a);
        }, function() {
      ...
      for (var d = 0,
        ...
        b = a(b, c[d]);
      return b;
    }, oc["catch"] = oc.catchError = oc.catchException = function(a) {
      return "function" == typeof a ? H(this, a) : Yc([this, a]);
    };
    var Yc = uc.catchError = uc["catch"] = uc.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    var Zc = uc.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = b.pop();
      return Array.isArray(b[0]) && (b = b[0]), new Ld(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new Tb;
            La(f) && (f = Ec(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    oc.concat = function() {
      for (var a = [],
          ...
          c = arguments.length; c > b; b++)
        a.push(arguments[b]);
      return a.unshift(this), _c.apply(null, a);
    };
    var $c = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = bc.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
    ...
    oc.concatAll = oc.concatObservable = function() {
      return this.merge(1);
    };
    var ad = function(a) {
      function b(b, c) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new Mb;
        return b.add(this.source.subscribe(new bd(a, this.maxConcurrent, b))), b;
      }, b;
    }(vc),
        bd = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new Tb;
            this.g.add(c), La(a) && (a = Ec(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    oc.merge = function(a) {
      return "number" != typeof a ? cd(this, a) : new ad(this, a);
    };
    var cd = uc.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), E(a, c).mergeAll();
        ...
        dd = function(a) {
          ...
          return Eb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new Tb;
              this.g.add(b), La(a) && (a = Ec(a)), b.setDisposable(a.subscribe(new d(this, this.g, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    oc.mergeAll = oc.mergeObservable = function() {
      return new dd(this);
    };
    var ed = Ea.CompositeError = function(a) {
    ...
    ed.prototype = Error.prototype, uc.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      var d = E(null, a);
      return new Ld(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : a.onError(1 === g.length ? g[0] : new ed(g));
        }
        var c = new Mb,
            e = new Tb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new Tb;
          c.add(e), La(d) && (d = Ec(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    }, oc.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return fd([this, a]);
    };
    var fd = uc.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Ld(function(b) {
        var c = 0,
            ...
            e = bc.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], La(f) && (f = Ec(f)), g = new Tb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new Mb(d, e);
      });
    };
    ...
    var gd = function(a) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new Tb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), La(a) && (a = Ec(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var hd = function(a) {
      function b(b, c) {
        this.source = b, this.other = La(c) ? Ec(c) : c, a.call(this);
      }
      function c(a) {
    ...
    oc.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Ld(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new Tb;
            La(d) && (d = Ec(d)), e.setDisposable(d.subscribe(function(a) {
              h[c] = a, f[c] = !0, g = f.every(Ga);
            }, function(b) {
              a.onError(b);
            }, Fa)), i[c] = e;
          }(j);
        ...
        return k.setDisposable(e.subscribe(function(b) {
          ...
          if (g) {
            ...
            return e === Hb ? a.onError(e.e) : void a.onNext(e);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new Ld(function(a) {
        for (var c = b.length,
            f = n(c, K),
            g = n(c, I),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new Tb;
            La(i) && (i = Ec(i)), j.setDisposable(i.subscribe(function(b) {
              ...
              g[c] = !0, g.every(Ga) && a.onCompleted();
            })), h[c] = j;
          }(i);
        return new Mb(h);
      }, d);
      ...
      return new Ld(function(b) {
        for (var c = a.length,
            ...
            g = 0; c > g; g++)
          !function(c) {
            f[c] = new Tb, f[c].setDisposable(a[c].subscribe(function(a) {
              ...
              e[c] = !0, e.every(Ga) && b.onCompleted();
            }));
          }(g);
        return new Mb(f);
      });
    ...
    }, oc.bufferWithCount = function(a, b) {
      ...
      var c = this;
      return b || (b = Ia), new Ld(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
    ...
    var id = function(a) {
      function b(b, c, d, e) {
        this.source = b, this.t = !c || Na(c) ? nc(c || Fa, d || Fa, e || Fa) : c, a.call(this);
      }
      function c(a, b) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          b === Hb && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
    ...
    oc["do"] = oc.tap = oc.doAction = function(a, b, c) {
      return new id(this, a, b, c);
    ...
    var jd = function(a) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a));
      }, c.prototype.onNext = Fa, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    M.prototype.onNext = function(a) {
      ...
      var a,
          b,
          c = !1;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new kd(this, b, c, a);
    ...
    }, oc.windowWithCount = function(a, b) {
      var c = this;
      ...
      return Na(a) && Na(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return La(e) && (e = Ec(e)), (bb(e) || ab(e)) && (e = Mc(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : Na(a) ? N(this, a, c) : N(this, function() {
        return a;
      });
    }, oc.concatMapObserver = oc.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = db(a, d, 2),
          g = db(b, d, 1),
          h = db(c, d, 0);
      return new Ld(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          La(c) && (c = Ec(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          La(b) && (b = Ec(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, oc.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Ld(function(a) {
        var d = !1;
    ...
    }, oc.groupBy = function(a, b, c) {
      return this.groupByUntil(a, b, Qc, c);
    }, oc.groupByUntil = function(a, b, c, d) {
      var e = this;
      return b || (b = Ga), d || (d = Ia), new Ld(function(f) {
        function g(a) {
          return function(b) {
            b.onError(a);
          };
    ...
    var ld = function(a) {
      ...
      return Eb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          ...
          return b === Hb ? this.o.onError(b.e) : void this.o.onNext(b);
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    oc.map = oc.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof ld ? this.internalMap(c, b) : new ld(this, c, b);
    }, oc.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, oc.flatMapObserver = oc.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Ld(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          La(c) && (c = Ec(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          La(a) && (a = Ec(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    ...
    var nd = function(a) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          return b === Hb ? this.o.onError(b.e) : void(b && this.o.onNext(a));
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    oc.filter = oc.where = function(a, b) {
      return this instanceof nd ? this.internalFilter(a, b) : new nd(this, a, b);
    }, oc.aggregate = function() {
      var a,
          b,
          c = !1,
          d = this;
      return 2 === arguments.length ? (c = !0, b = arguments[0], a = arguments[1]) : a = arguments[0], new Ld(function(e) {
        var f,
            g,
            h;
    ...
    var od = function(a) {
      ...
      return Eb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        this.isStopped || (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.result = p(this.acc)(this.result, a) : (this.result = this.hasSeed ? p(this.acc)(this.seed, a) : a, this.hasAccumulation = !0), this.result === Hb && this.o.onError(this.result.e));
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.hasValue && this.o.onNext(this.result), !this.hasValue && this.hasSeed && this.o.onNext(this.seed), !this.hasValue && !this.hasSeed && this.o.onError(new Ta), this.o.onCompleted());
      }, c.prototype.dispose = function() {
        this.isStopped = !0;
      }, c.prototype.fail = function(a) {
        return this.isStopped ? !1 : (this.isStopped = !0, this.o.onError(a), !0);
    ...
    oc.reduce = function(a) {
      var b = !1;
      if (2 === arguments.length) {
        b = !0;
        var c = arguments[1];
      }
      return new od(this, a, b, c);
    }, oc.some = function(a, b) {
      var c = this;
      return a ? c.filter(a, b).some() : new Ld(function(a) {
    ...
    }, oc.every = function(a, b) {
      return this.filter(function(b) {
        return !a(b);
      }, b).some().map(Ma);
    }, oc.all = function() {
      return this.every.apply(this, arguments);
    }, oc.includes = function(a, b) {
      function c(a, b) {
    ...
    }, oc.contains = function(a, b) {
      oc.includes(a, b);
    }, oc.count = function(a, b) {
      return a ? this.filter(a, b).count() : this.reduce(function(a) {
        return a + 1;
      }, 0);
    }, oc.indexOf = function(a, b) {
      var c = this;
      return new Ld(function(d) {
        var e = 0,
            f = +b || 0;
    ...
    }, oc.minBy = function(a, b) {
      return b || (b = Ja), R(this, a, function(a, c) {
        return -1 * b(a, c);
      });
    }, oc.min = function(a) {
    ...
    }, oc.maxBy = function(a, b) {
      return b || (b = Ja), R(this, a, b);
    }, oc.max = function(a) {
      return this.maxBy(Ga, a).map(function(a) {
        return S(a);
      });
    }, oc.average = function(a, b) {
    ...
    }, oc.elementAt = function(a) {
      return T(this, a, !1);
    }, oc.elementAtOrDefault = function(a, b) {
      return T(this, a, !0, b);
    }, oc.single = function(a, b) {
      return a && Na(a) ? this.where(a, b).single() : U(this, !1);
    }, oc.singleOrDefault = function(a, b, c) {
      return a && Na(a) ? this.filter(a, c).singleOrDefault(null, b) : U(this, !0, b);
    }, oc.first = function(a, b) {
      return a ? this.where(a, b).first() : V(this, !1);
    }, oc.firstOrDefault = function(a, b, c) {
      return a ? this.where(a).firstOrDefault(null, b) : V(this, !0, b);
    }, oc.last = function(a, b) {
      return a ? this.where(a, b).last() : W(this, !1);
    }, oc.lastOrDefault = function(a, b, c) {
      return a ? this.where(a, c).lastOrDefault(null, b) : W(this, !0, b);
    }, oc.find = function(a, b) {
      return X(this, a, b, !1);
    }, oc.findIndex = function(a, b) {
      return X(this, a, b, !0);
    }, oc.toSet = function() {
        ...
        rd = Ea.spawn = function(a) {
          ...
          return function(c) {
            ...
            function e(a, b) {
              ...
              if (c.value = Y(c.value, f), typeof c.value !== pd)
    ...
    uc.start = function(a, b, c) {
      return sd(a, b, c)();
    };
    var sd = uc.toAsync = function(a, b, c) {
    ...
    uc.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, uc.fromNodeCallback = function(a, b, c) {
      return function() {
        for (var d = arguments.length,
            e = new Array(d),
            f = 0; d > f; f++)
    ...
    }, Ea.config.useNativeEvents = !1, uc.fromEvent = function(a, b, c) {
      return a.addListener ? td(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : Ea.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Ld(function(d) {
      ...
      }).publish().refCount() : td(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var td = uc.fromEventPattern = function(a, b, c) {
      return new Ld(function(d) {
        function e(a) {
          var b = a;
          if (c)
    ...
    var ud = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Od, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
    ...
    var vd = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = ia(this.source, this.pauser.distinctUntilChanged().startWith(!1), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new Od, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
    ...
    var wd = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new xd(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return Eb(c, a), c.prototype.request = function(a) {
        ...
        xd = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Od, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = Qb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || cc;
          }
          return Eb(c, a), Fb(c.prototype, mc, {
    ...
    oc.controlled = function(a, b) {
      return a && Zb(a) && (b = a, a = !0), null == a && (a = !0), new wd(this, a, b);
    };
    var yd = function(a) {
      function b(a) {
    ...
    wd.prototype.stopAndWait = function() {
      return new yd(this);
    };
    var zd = function(a) {
      function b(a) {
    ...
    wd.prototype.windowed = function(a) {
      ...
      var c = this;
      return "function" == typeof a ? new Ld(function(d) {
        var e = c.multicast(a());
    ...
    var Bd = Ea.BehaviorSubject = function(a) {
      function c(a) {
        return Sb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), Qb) : (this.observers.push(a), a.onNext(this.value), new Ad(this, a));
      }
      function d(b) {
        a.call(this, c), this.value = b, this.observers = [], this.isDisposed = !1, this.isStopped = !1, this.hasError = !1;
      }
      return Eb(d, a), Fb(d.prototype, mc, {
        getValue: function() {
        ...
        Cd = Ea.ReplaySubject = function(a) {
          function c(a, b) {
            return Pb(function() {
          ...
          return Eb(e, a), Fb(e.prototype, mc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
        ...
        Dd = Ea.ConnectableObservable = function(a) {
          function b(b, c) {
            var d,
                e = !1,
                f = b.asObservable();
    ...
    oc.letBind = oc.let = function(a) {
      return a(this);
    }, uc["if"] = uc.ifThen = function(a, b, c) {
      return Gc(function() {
        return c || (c = Ic()), La(b) && (b = Ec(b)), La(c) && (c = Ec(c)), "function" == typeof c.now && (c = Ic(c)), a() ? b : c;
      });
    }, uc["for"] = uc.forIn = function(a, b, c) {
      return Cc(a, b, c).concat();
    };
    var Gd = uc["while"] = uc.whileDo = function(a, b) {
      return La(b) && (b = Ec(b)), ma(a, b).concat();
    };
    oc.doWhile = function(a) {
      return _c([this, Gd(a, this)]);
    }, uc["case"] = uc.switchCase = function(a, b, c) {
      return Gc(function() {
        La(c) && (c = Ec(c)), c || (c = Ic()), "function" == typeof c.now && (c = Ic(c));
        var d = b[a()];
        return La(d) && (d = Ec(d)), d || c;
      });
    }, oc.expand = function(a, b) {
      Zb(b) || (b = bc);
      var c = this;
      return new Ld(function(d) {
        var e = [],
      ...
      return new Ld(function(b) {
        ...
        for (var d = new Mb,
          ...
          !function(i) {
            var j = a[i];
            La(j) && (j = Ec(j)), d.add(j.subscribe(function(a) {
              e || (f[i] = !0, h[i] = a);
            }, function(a) {
      ...
      return new Ld(function(d) {
        var e,
            ...
            k = new Tb,
            l = new Tb;
        return La(a) && (a = Ec(a)), k.setDisposable(c.subscribe(function(a) {
          i = !0, e = a;
        }, function(a) {
    ...
    }, oc.manySelect = oc.extend = function(a, b) {
      Zb(b) || (b = bc);
      var c = this;
      return Gc(function() {
        var d;
    ...
    var Hd = function(a) {
      ...
      function c(c) {
        a.call(this, b), this.head = c, this.tail = new Pd;
      }
      return Eb(c, a), Fb(c.prototype, mc, {
        onCompleted: function() {
          this.onNext(uc.empty());
        },
        onError: function(a) {
          this.onNext(uc.throwError(a));
        },
        onNext: function(a) {
    ...
    {
      var Kd = uc.interval = function(a, b) {
        return ua(a, a, Zb(b) ? b : gc);
      };
      uc.timer = function(b, c, d) {
        var e;
    ...
    oc.delay = function(a, b) {
    ...
    }, oc.windowWithTime = function(a, b, c) {
      var d,
          e = this;
      return null == b && (d = a), Zb(c) || (c = gc), "number" == typeof b ? d = b : Zb(b) && (d = a, c = b), new Ld(function(b) {
        function f() {
          var a = new Tb,
              e = !1,
              g = !1;
        ...
        var g,
            ...
            l = new Ub,
            m = 0;
        return g = new Mb(l), h = new Vb(g), k.push(new Od), b.onNext(Gb(k[0], h)), f(), g.add(e.subscribe(function(a) {
          for (var b = 0,
              c = k.length; c > b; b++)
            k[b].onNext(a);
        }, function(a) {
    ...
    }, oc.windowWithTimeOrCount = function(a, b, c) {
      var d = this;
      return Zb(c) || (c = gc), new Ld(function(e) {
        function f(b) {
          var d = new Tb;
          g.setDisposable(d), d.setDisposable(c.scheduleWithRelative(a, function() {
            if (b === k) {
              j = 0;
              var a = ++k;
              l.onCompleted(), l = new Od, e.onNext(Gb(l, i)), f(a);
            }
          }));
        }
        var g = new Ub,
        ...
        return e.onNext(Gb(l, i)), f(0), h.add(d.subscribe(function(a) {
          var c = 0,
              d = !1;
          l.onNext(a), ++j === b && (d = !0, j = 0, c = ++k, l.onCompleted(), l = new Od, e.onNext(Gb(l, i))), d && f(c);
        }, function(a) {
      ...
      return Zb(b) || (b = gc), "number" == typeof a ? xa(this, Kd(a, b)) : xa(this, a);
    }, oc.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = Xc(new Error(b || "Timeout"))), Zb(c) || (c = gc);
      var d = this,
      ...
      return new Ld(function(f) {
        function g() {
          ...
          l.setDisposable(c[e](a, function() {
            h === d && (La(b) && (b = Ec(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new Tb,
    ...
    }, uc.generateWithAbsoluteTime = function(a, b, c, d, e, f) {
      return Zb(f) || (f = gc), new Ld(function(g) {
        var h = !0,
            i = !1;
    ...
    }, uc.generateWithRelativeTime = function(a, b, c, d, e, f) {
      return Zb(f) || (f = gc), new Ld(function(g) {
        var h = !0,
            i = !1;
    ...
    }, oc.delaySubscription = function(a, b) {
      var c = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative",
          d = this;
      return Zb(b) || (b = gc), new Ld(function(e) {
        var f = new Ub;
        return f.setDisposable(b[c](a, function() {
          f.setDisposable(d.subscribe(e));
        })), f;
      }, this);
    }, oc.delayWithSelector = function(a, b) {
      var c,
          d,
          e = this;
      return Na(a) ? d = a : (c = a, d = b), new Ld(function(a) {
        function b() {
    ...
    }, oc.timeoutWithSelector = function(a, b, c) {
      1 === arguments.length && (b = a, a = Qc()), c || (c = Xc(new Error("Timeout")));
      var d = this;
      return new Ld(function(e) {
        function f(a) {
          function b() {
    ...
    }, oc.debounceWithSelector = function(a) {
      var b = this;
      return new Ld(function(c) {
        var d,
            e = !1,
    ...
    }, oc.throttleWithSelector = function(a) {
      return this.debounceWithSelector(a);
    }, oc.skipLastWithTime = function(a, b) {
      Zb(b) || (b = gc);
      var c = this;
      return new Ld(function(d) {
        var e = [];
    ...
    }, oc.takeLastWithTime = function(a, b) {
      var c = this;
      return Zb(b) || (b = gc), new Ld(function(d) {
        var e = [];
        return c.subscribe(function(c) {
          var d = b.now();
          for (e.push({
    ...
    }, oc.takeLastBufferWithTime = function(a, b) {
      var c = this;
      return Zb(b) || (b = gc), new Ld(function(d) {
        var e = [];
        return c.subscribe(function(c) {
    ...
    }, oc.skipUntilWithTime = function(a, b) {
      Zb(b) || (b = gc);
      var c = this,
    ...
    }, oc.takeUntilWithTime = function(a, b) {
      Zb(b) || (b = gc);
      var c = this,
          d = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Ld(function(e) {
      ...
      return new Ld(function(a) {
        ...
        return h.add(g), g.setDisposable(c.subscribe(function(c) {
          e || (e = !0, innerSubscription = new Tb, h.add(innerSubscription), La(c) && (c = Ec(c)), innerSubscription.setDisposable(c.subscribe(function(e) {
            var f;
            try {
              f = d(e, b++, c);
            } catch (g) {
    ...
    var Ld = Ea.AnonymousObservable = function(a) {
      function b(a) {
        return a && Na(a.dispose) ? a : Na(a) ? Pb(a) : Qb;
      }
      function c(a, c) {
      ...
      return Eb(d, a), d;
        ...
        Nd = function(a) {
          ...
          function c(c, d, e) {
            a.call(this, b), this.key = c, this.underlyingObservable = e ? new Ld(function(a) {
              return new Mb(e.getDisposable(), d.subscribe(a));
            }) : d;
          }
          return Eb(c, a), c;
        }(uc),
        Od = Ea.Subject = function(a) {
          function c(a) {
            return Sb(this), this.isStopped ? this.hasError ? (a.onError(this.error), Qb) : (a.onCompleted(), Qb) : (this.observers.push(a), new Ad(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
          }
          return Eb(d, a), Fb(d.prototype, mc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            onCompleted: function() {
        ...
        Pd = Ea.AsyncSubject = function(a) {
          function c(a) {
            return Sb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), Qb) : (this.observers.push(a), new Ad(this, a));
          }
          function d() {
        ...
        Qd = Ea.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Eb(c, a), Fb(c.prototype, mc.prototype, {
            onCompleted: function() {
    ...
    }(Od), "function" == typeof define && "object" == typeof define.amd && define.amd ? (za.Rx = Ea, define(function() {
      return Ea;
