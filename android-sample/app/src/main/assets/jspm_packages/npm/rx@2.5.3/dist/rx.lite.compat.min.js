...
(function(process) {
  (function(a) {
    ...
    function L(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return ka(e) && (e = Gc(e)), (Ba(e) || Aa(e)) && (e = cc(e)), e;
      }).concatAll();
    }
    function M(a, b, c) {
      var d = Da(b, c, 3);
 ...
 while (null !== g);
    ...
    function X(a, b) {
      return new Nc(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new jb(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    ...
    var Db,
        Eb = tb.timeout = tb["default"] = function() {
          function a(a, b) {
            var c = this,
                d = new qb,
                e = wb(function() {
        ...
        Fb = da.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return vb(a) || (a = yb), new Nc(function(c) {
        ...
        Gb = Fb.createOnNext = function() {
          ...
          return function(d) {
            return new Fb("N", d, null, a, b, c);
          };
        }(),
        Hb = Fb.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new Fb("E", null, d, a, b, c);
          };
        }(),
        Ib = Fb.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new Fb("C", null, null, a, b, c);
          };
        }(),
        Jb = da.Observer = function() {},
        Kb = Jb.create = function(a, b, c) {
          return a || (a = ea), b || (b = ja), c || (c = ea), new Mb(a, b, c);
        },
        Lb = da.internals.AbstractObserver = function(a) {
          function b() {
        ...
        Mb = da.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Nb = da.Observable = function() {
          ...
          return Db = a.prototype, Db.subscribe = Db.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Kb(a, b, c));
          }, Db.subscribeOnNext = function(a, b) {
            return this._subscribe(Kb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Db.subscribeOnError = function(a, b) {
            return this._subscribe(Kb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Db.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Kb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, a;
        }(),
        Ob = da.ObservableBase = function(a) {
          function b(a) {
        ...
        Pb = da.internals.Enumerable = function() {},
        Qb = function(a) {
          function b(b) {
          ...
          return db(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new rb,
                e = yb.scheduleRecursiveWithState(this.sources[ya](), function(e, f) {
                  if (!b) {
    ...
    var Rb = function(a) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[ya](),
            d = new rb,
            e = yb.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
    ...
    Pb.prototype.catchError = function() {
      return new Rb(this);
    }, Pb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Nc(function(c) {
        var d,
            e,
            ...
            l = yb.scheduleRecursive(function(a) {
              if (!d) {
                ...
                var i = new qb,
                    l = new qb;
                k.setDisposable(new jb(l, i)), i.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
    ...
    var Sb = function(a) {
      ...
      return db(b, a), b.prototype[ya] = function() {
        return new c(this);
        ...
        Tb = Pb.repeat = function(a, b) {
          return new Sb(a, b);
        },
        Ub = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? Da(b, c, 3) : null;
          }
          function c(a) {
        ...
        Vb = Pb.of = function(a, b, c) {
          return new Ub(a, b, c);
        },
        Wb = da.internals.ScheduledObserver = function(a) {
          function b(b, c) {
    ...
    var Yb = Nb.defer = function(a) {
      return new Nc(function(b) {
        ...
        return ka(c) && (c = Gc(c)), c.subscribe(b);
      });
    },
        Zb = function(a) {
          function b(b) {
        ...
        $b = Nb.empty = function(a) {
          return vb(a) || (a = yb), new Zb(a);
        },
        _b = function(a) {
          function b(b, c, d) {
    ...
    var cc = Nb.from = function(a, b, c, d) {
      if (null == a)
    ...
    {
      var ec = Nb.fromArray = function(a, b) {
        return vb(b) || (b = zb), new dc(a, b);
      },
          fc = function(a) {
            function b() {
              a.call(this);
    ...
    var kc = function(a) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        lc = (Nb["return"] = Nb.just = Nb.returnValue = function(a, b) {
          return vb(b) || (b = yb), new kc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        mc = Nb["throw"] = Nb.throwError = Nb.throwException = function(a, b) {
          return vb(b) || (b = yb), new lc(a, b);
        };
    Db["catch"] = Db.catchError = Db.catchException = function(a) {
      return "function" == typeof a ? F(this, a) : nc([this, a]);
    };
    var nc = Nb.catchError = Nb["catch"] = Nb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    var oc = Nb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = b.pop();
      return Array.isArray(b[0]) && (b = b[0]), new Nc(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new qb;
            ka(f) && (f = Gc(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    var pc = function(a) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = yb.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
        ...
        return new jb(b, f, mb(function() {
          a = !0;
        }));
      }, b;
    }(Ob),
        qc = Nb.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    Db.concatAll = Db.concatObservable = function() {
      return this.merge(1);
    };
    var rc = function(a) {
      function b(b, c) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        sc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new qb;
            this.g.add(c), ka(a) && (a = Gc(a)), c.setDisposable(a.subscribe(new b(this, c)));
      ...
      return Array.isArray(c[0]) && (c = c[0]), C(a, c).mergeAll();
        ...
        uc = function(a) {
          ...
          return db(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new qb;
              this.g.add(b), ka(a) && (a = Gc(a)), b.setDisposable(a.subscribe(new d(this, this.g, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    Db.mergeAll = Db.mergeObservable = function() {
      return new uc(this);
    };
    var vc = da.CompositeError = function(a) {
    ...
    vc.prototype = Error.prototype, Nb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Nc(function(a) {
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new qb;
          c.add(e), ka(d) && (d = Gc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var wc = function(a) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new qb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), ka(a) && (a = Gc(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var xc = function(a) {
      function b(b, c) {
        this.source = b, this.other = ka(c) ? Gc(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return db(b, a), b.prototype.subscribeCore = function(a) {
        return new jb(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    Db.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Nc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new qb;
            ka(d) && (d = Gc(d)), e.setDisposable(d.subscribe(function(a) {
              h[c] = a, f[c] = !0, g = f.every(fa);
            }, function(b) {
              a.onError(b);
            }, ea)), i[c] = e;
          }(j);
        ...
        return k.setDisposable(e.subscribe(function(b) {
          ...
          if (g) {
            ...
            return e === bb ? a.onError(e.e) : void a.onNext(e);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new Nc(function(a) {
        for (var c = b.length,
            f = q(c, I),
            g = q(c, G),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new qb;
            ka(i) && (i = Gc(i)), j.setDisposable(i.subscribe(function(b) {
              ...
              g[c] = !0, g.every(fa) && a.onCompleted();
            })), h[c] = j;
          }(i);
        return new jb(h);
      }, d);
      ...
      return new Nc(function(b) {
        for (var c = a.length,
            ...
            g = 0; c > g; g++)
          !function(c) {
            f[c] = new qb, f[c].setDisposable(a[c].subscribe(function(a) {
              ...
              e[c] = !0, e.every(fa) && b.onCompleted();
            }));
          }(g);
        return new jb(f);
      });
      ...
      var c = this;
      return b || (b = ha), new Nc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
    ...
    var yc = function(a) {
      function b(b, c, d, e) {
        this.source = b, this.t = !c || la(c) ? Kb(c || ea, d || ea, e || ea) : c, a.call(this);
      }
      function c(a, b) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          b === bb && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
    ...
    }, Db["finally"] = Db.ensure = function(a) {
      var b = this;
      return new Nc(function(c) {
        var d;
        try {
    ...
    var zc = function(a) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a));
      }, c.prototype.onNext = ea, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    Db.ignoreElements = function() {
      ...
      return new Nc(function(b) {
        return a.subscribe(function(a) {
          ...
          b.onNext(Hb(a)), b.onCompleted();
        }, function() {
          b.onNext(Ib()), b.onCompleted();
        });
      }, a);
    }, Db.repeat = function(a) {
      return Tb(this, a).concat();
    }, Db.retry = function(a) {
      return Tb(this, a).catchError();
    }, Db.retryWhen = function(a) {
      return Tb(this).catchErrorWhen(a);
    };
    var Ac = function(a) {
      function b(b, c, d, e) {
    ...
    K.prototype.onNext = function(a) {
      ...
      var a,
          b,
          c = !1;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new Ac(this, b, c, a);
    ...
    }, Db.selectConcat = Db.concatMap = function(a, b, c) {
      return la(a) && la(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return ka(e) && (e = Gc(e)), (Ba(e) || Aa(e)) && (e = cc(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : la(a) ? L(this, a, c) : L(this, function() {
        return a;
      });
    };
    var Bc = function(a) {
      ...
      return db(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          ...
          return b === bb ? this.o.onError(b.e) : void this.o.onNext(b);
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    Db.map = Db.select = function(a, b) {
      ...
      return this instanceof Bc ? this.internalMap(c, b) : new Bc(this, c, b);
    }, Db.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, Db.selectMany = Db.flatMap = function(a, b, c) {
    ...
    }, Db.selectSwitch = Db.flatMapLatest = Db.switchMap = function(a, b) {
    ...
    var Dc = function(a) {
      ...
      return db(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          return b === bb ? this.o.onError(b.e) : void(b && this.o.onNext(a));
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    Db.filter = Db.where = function(a, b) {
      return this instanceof Dc ? this.internalFilter(a, b) : new Dc(this, a, b);
    }, Nb.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, Nb.fromNodeCallback = function(a, b, c) {
      return function() {
        for (var d = arguments.length,
            e = new Array(d),
            f = 0; d > f; f++)
    ...
    }, da.config.useNativeEvents = !1, Nb.fromEvent = function(a, b, c) {
      return a.addListener ? Ec(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : da.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Nc(function(d) {
      ...
      }).publish().refCount() : Ec(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var Ec = Nb.fromEventPattern = function(a, b, c) {
      return new Nc(function(d) {
        function e(a) {
          var b = a;
          if (c)
    ...
    Db.toPromise = function(a) {
      ...
      return Gc(b);
    }, Db.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new Nc(function(d) {
        var e = c.multicast(a());
        return new jb(b(e).subscribe(d), e.connect());
      }, c) : new Hc(c, a);
    }, Db.publish = function(a) {
      return a && la(a) ? this.multicast(function() {
        return new Qc;
      }, a) : this.multicast(new Qc);
    }, Db.share = function() {
      return this.publish().refCount();
    }, Db.publishLast = function(a) {
      return a && la(a) ? this.multicast(function() {
        return new Rc;
      }, a) : this.multicast(new Rc);
    }, Db.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new Tc(b);
      }, a) : this.multicast(new Tc(a));
    }, Db.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, Db.replay = function(a, b, c, d) {
      return a && la(a) ? this.multicast(function() {
        return new Uc(b, c, d);
      }, a) : this.multicast(new Uc(b, c, d));
    }, Db.shareReplay = function(a, b, c) {
      return this.replay(null, a, b, c).refCount();
    };
    {
      var Hc = da.ConnectableObservable = function(a) {
        function b(b, c) {
          var d,
              e = !1,
              f = b.asObservable();
        ...
        return db(b, a), b.prototype.refCount = function() {
          ...
          Ic = Nb.interval = function(a, b) {
            return U(a, a, vb(b) ? b : Eb);
          };
      Nb.timer = function(b, c, d) {
        var e;
        return vb(d) || (d = Eb), c !== a && "number" == typeof c ? e = c : vb(c) && (d = c), b instanceof Date && e === a ? R(b.getTime(), d) : b instanceof Date && e !== a ? (e = c, S(b.getTime(), e, d)) : e === a ? T(b, d) : U(b, e, d);
      };
    }
    Db.delay = function(a, b) {
      return vb(b) || (b = Eb), a instanceof Date ? W(this, a.getTime(), b) : V(this, a, b);
    }, Db.debounce = Db.throttleWithTimeout = function(a, b) {
      vb(b) || (b = Eb);
      var c = this;
      return new Nc(function(d) {
        var e,
    ...
    }, Db.throttle = function(a, b) {
      return this.debounce(a, b);
    }, Db.timestamp = function(a) {
      return vb(a) || (a = Eb), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, Db.sample = Db.throttleLatest = function(a, b) {
      return vb(b) || (b = Eb), "number" == typeof a ? X(this, Ic(a, b)) : X(this, a);
    }, Db.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = mc(new Error(b || "Timeout"))), vb(c) || (c = Eb);
      var d = this,
          e = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Nc(function(f) {
        function g() {
          var d = h;
          l.setDisposable(c[e](a, function() {
            h === d && (ka(b) && (b = Gc(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new qb,
    ...
    var Jc = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Qc, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
    ...
    var Kc = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = Y(this.source, this.pauser.distinctUntilChanged().startWith(!1), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new Qc, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
    ...
    Db.pausableBuffered = function(a) {
    ...
    var Lc = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new Mc(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return db(c, a), c.prototype.request = function(a) {
        ...
        Mc = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Qc, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = nb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || zb;
          }
          return db(c, a), eb(c.prototype, Jb, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Fb.createOnCompleted()) : this.subject.onCompleted();
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Fb.createOnError(a)) : this.subject.onError(a);
            },
            onNext: function(a) {
              var b = !1;
              0 === this.requestedCount ? this.enableQueue && this.queue.push(Fb.createOnNext(a)) : (-1 !== this.requestedCount && 0 === this.requestedCount-- && this.disposeCurrentRequest(), b = !0), b && this.subject.onNext(a);
            },
    ...
    Db.controlled = function(a, b) {
      return a && vb(a) && (b = a, a = !0), null == a && (a = !0), new Lc(this, a, b);
    }, Db.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    var Nc = da.AnonymousObservable = function(a) {
      function b(a) {
        return a && la(a.dispose) ? a : la(a) ? mb(a) : nb;
      }
      function c(a, c) {
    ...
    var Qc = da.Subject = function(a) {
      function c(a) {
        return pb(this), this.isStopped ? this.hasError ? (a.onError(this.error), nb) : (a.onCompleted(), nb) : (this.observers.push(a), new Pc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return db(d, a), eb(d.prototype, Jb.prototype, {
        ...
        Rc = da.AsyncSubject = function(a) {
          function c(a) {
            return pb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), nb) : (this.observers.push(a), new Pc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return db(d, a), eb(d.prototype, Jb, {
            hasObservers: function() {
        ...
        Sc = da.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return db(c, a), eb(c.prototype, Jb.prototype, {
            onCompleted: function() {
        ...
        Tc = da.BehaviorSubject = function(a) {
          function c(a) {
            return pb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), nb) : (this.observers.push(a), a.onNext(this.value), new Pc(this, a));
          }
          function d(b) {
        ...
        Uc = da.ReplaySubject = function(a) {
          function c(a, b) {
            return mb(function() {
          ...
          return db(e, a), eb(e.prototype, Jb.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
    ...
    }(Qc), "function" == typeof define && "object" == typeof define.amd && define.amd ? ($.Rx = da, define(function() {
      return da;
