...
(function(process) {
  (function(a) {
    ...
    function y(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new t(b), c[wa]();
      if (!d && b.length !== a)
        return c = new v(b), c[wa]();
      if (!d)
    ...
    function A(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && x(b) ? (b = z(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Zb ? Zb : b) : b;
    }
    function B(a, b) {
      this.observer = a, this.parent = b;
    }
    function C(a, b) {
      return rb(a) || (a = vb), new _b(b, a);
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function L(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return ia(e) && (e = Cc(e)), (za(e) || ya(e)) && (e = $b(e)), e;
      }).concatAll();
    }
    function M(a, b, c) {
      var d = Ba(b, c, 3);
 ...
 while (null !== g);
    ...
    function V(a, b) {
      return new Jc(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new fb(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    function W(a, b, c) {
      return new Jc(function(d) {
        function e(a, b) {
          if (j[b] = a, g[b] = !0, h || (h = g.every(da))) {
            if (f)
              return d.onError(f);
            var e = o(c).apply(null, j);
            if (e === _a)
    ...
    var ba = {
      ...
      helpers: {}
        ...
        }, ba.helpers.identity = function(a) {
          return a;
        }),
        ea = (ba.helpers.pluck = function(a) {
          return function(b) {
            return b[a];
          };
        ...
        ja = (ba.helpers.asArray = function() {
    ...
    var Xa = ba.internals.isObject = function(a) {
      var b = typeof a;
    ...
    {
      var Za,
          $a = ba.internals.isEqual = function(a, b) {
            return m(a, b, [], []);
          },
          _a = {e: {}},
          ab = ({}.hasOwnProperty, Array.prototype.slice),
          bb = this.inherits = ba.internals.inherits = function(a, b) {
            function c() {
              this.constructor = a;
            }
    ...
    var db = ba.internals.PriorityQueue = function(a) {
    ...
    var fb = ba.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var hb = ba.Disposable = function(a) {
    ...
    var ob = (ba.RefCountDisposable = function() {
      function a(a) {
    ...
    var sb,
        tb,
        ub = pb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new pb(ea, a, va, va);
        }(),
        vb = pb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
        ...
        wb = (ba.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
    ...
    !function() {
      ...
      if (ja(h))
        ...
        Y.addEventListener ? Y.addEventListener("message", c, !1) : Y.attachEvent ? Y.attachEvent("onmessage", c) : Y.onmessage = c, sb = function(a) {
          var b = d++;
        ...
        sb = "document" in Y && "onreadystatechange" in Y.document.createElement("script") ? function(b) {
          ...
          var c = d++;
          return e[c] = b, xb(function() {
            a(c);
          }, 0), c;
        };
    }();
    var zb,
        Ab = pb.timeout = pb["default"] = function() {
          function a(a, b) {
            var c = this,
                d = new mb,
                e = sb(function() {
        ...
        Bb = ba.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return rb(a) || (a = ub), new Jc(function(c) {
        ...
        Fb = ba.Observer = function() {},
        Gb = Fb.create = function(a, b, c) {
          return a || (a = ca), b || (b = ha), c || (c = ca), new Ib(a, b, c);
        },
        Hb = ba.internals.AbstractObserver = function(a) {
          function b() {
        ...
        Ib = ba.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Jb = ba.Observable = function() {
          function a(a) {
            if (ba.config.longStackSupport && ka) {
              try {
                throw new Error;
              } catch (b) {
        ...
        Lb = ba.ObservableBase = function(a) {
          function b(a) {
          ...
          function d(a) {
            var b = new Kc(a),
                d = [b, this];
            return vb.scheduleRequired() ? vb.scheduleWithState(d, c) : c(null, d), b;
          }
          function e() {
            a.call(this, d);
          }
        ...
        Mb = ba.internals.Enumerable = function() {},
        Nb = function(a) {
          function b(b) {
          ...
          return bb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new nb,
                e = ub.scheduleRecursiveWithState(this.sources[wa](), function(e, f) {
                  if (!b) {
                    var g = o(e.next).call(e);
                    if (g === _a)
    ...
    var Ob = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[wa](),
            d = new nb,
            e = ub.scheduleRecursiveWithState(null, function(e, f) {
              if (!b) {
                var g = o(c.next).call(c);
                if (g === _a)
                  return a.onError(g.e);
                if (g.done)
    ...
    Mb.prototype.catchError = function() {
      ...
      return new Jc(function(c) {
        var d,
            ...
            j = b[wa](),
            k = new nb,
            l = ub.scheduleRecursive(function(a) {
              if (!d) {
                var b = o(j.next).call(j);
                if (b === _a)
                ...
                var i = new mb,
                    l = new mb;
                k.setDisposable(new fb(l, i)), i.setDisposable(h.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
    ...
    var Pb = function(a) {
      ...
      return bb(b, a), b.prototype[wa] = function() {
        return new c(this);
      }, c.prototype.next = function() {
        return 0 === this.l ? xa : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
        ...
        Rb = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? Ba(b, c, 3) : null;
          }
          function c(a) {
    ...
    zb.toArray = function() {
      return new Tb(this);
    }, Jb.create = Jb.createWithDisposable = function(a, b) {
      return new Jc(a, b);
    };
    var Ub = Jb.defer = function(a) {
      return new Jc(function(b) {
        ...
        return ia(c) && (c = Cc(c)), c.subscribe(b);
      });
    },
        Vb = function(a) {
          function b(b) {
        ...
        Wb = Jb.empty = function(a) {
          return rb(a) || (a = ub), new Vb(a);
        },
        Xb = function(a) {
          function b(b, c, d) {
    ...
    var $b = Jb.from = function(a, b, c, d) {
      if (null == a)
    ...
    {
      var ac = Jb.fromArray = function(a, b) {
        return rb(b) || (b = vb), new _b(a, b);
      },
          bc = function(a) {
            function b() {
              a.call(this);
    ...
    var gc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        hc = (Jb["return"] = Jb.just = Jb.returnValue = function(a, b) {
          return rb(b) || (b = ub), new gc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        ic = Jb["throw"] = Jb.throwError = Jb.throwException = function(a, b) {
          return rb(b) || (b = ub), new hc(a, b);
        };
    zb["catch"] = zb.catchError = zb.catchException = function(a) {
      return "function" == typeof a ? F(this, a) : jc([this, a]);
    };
    var jc = Jb.catchError = Jb["catch"] = Jb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    var kc = Jb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Jc(function(a) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new mb;
            ia(f) && (f = Cc(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    var lc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = ub.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
        ...
        return new fb(b, f, ib(function() {
          a = !0;
        }));
      }, b;
    }(Lb),
        mc = Jb.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    zb.concatAll = zb.concatObservable = function() {
      return this.merge(1);
    };
    var nc = function(a) {
      function b(b, c) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        oc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new mb;
            this.g.add(c), ia(a) && (a = Cc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    var pc = Jb.merge = function() {
      ...
      return Array.isArray(c[0]) && (c = c[0]), C(a, c).mergeAll();
        ...
        qc = ba.CompositeError = function(a) {
    ...
    qc.prototype = Error.prototype, Jb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Jc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : a.onError(1 === g.length ? g[0] : new qc(g));
        }
        var c = new fb,
            e = new mb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new mb;
          c.add(e), ia(d) && (d = Cc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var rc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new mb;
          this.g.add(b), ia(a) && (a = Cc(a)), b.setDisposable(a.subscribe(new d(this, this.g, b)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    zb.mergeAll = zb.mergeObservable = function() {
      return new rc(this);
    }, zb.skipUntil = function(a) {
      var b = this;
      return new Jc(function(c) {
        var d = !1,
    ...
    var sc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new mb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), ia(a) && (a = Cc(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    zb["switch"] = zb.switchLatest = function() {
      return new sc(this);
    };
    var tc = function(a) {
      function b(b, c) {
        this.source = b, this.other = ia(c) ? Cc(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return new fb(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    zb.takeUntil = function(a) {
      return new tc(this, a);
    }, zb.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Jc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new mb;
            ia(d) && (d = Cc(d)), e.setDisposable(d.subscribe(function(a) {
              h[c] = a, f[c] = !0, g = f.every(da);
            }, function(b) {
              a.onError(b);
            }, ca)), i[c] = e;
          }(j);
        ...
        return k.setDisposable(e.subscribe(function(b) {
          var c = [b].concat(h);
          if (g) {
            var e = o(d).apply(null, c);
            return e === _a ? a.onError(e.e) : void a.onNext(e);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new Jc(function(a) {
        for (var c = b.length,
            f = q(c, I),
            g = q(c, G),
            h = new Array(c),
          ...
          !function(c) {
            var i = b[c],
                j = new mb;
            ia(i) && (i = Cc(i)), j.setDisposable(i.subscribe(function(b) {
      ...
      return new Jc(function(b) {
        for (var c = a.length,
            ...
            g = 0; c > g; g++)
          !function(c) {
            f[c] = new mb, f[c].setDisposable(a[c].subscribe(function(a) {
              ...
              e[c] = !0, e.every(da) && b.onCompleted();
            }));
          }(g);
        return new fb(f);
      });
    }, zb.asObservable = function() {
      var a = this;
      return new Jc(function(b) {
        return a.subscribe(b);
      }, a);
    }, zb.dematerialize = function() {
      var a = this;
      return new Jc(function(b) {
    ...
    }, zb.distinctUntilChanged = function(a, b) {
      var c = this;
      return b || (b = fa), new Jc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
    ...
    var uc = function(a) {
      function b(b, c, d, e) {
        this.source = b, this.t = !c || ja(c) ? Gb(c || ca, d || ca, e || ca) : c, a.call(this);
      }
      function c(a, b) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = o(this.t.onNext).call(this.t, a);
          b === _a && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
          var b = o(this.t.onError).call(this.t, a);
          if (b === _a)
        ...
        if (!this.isStopped) {
          this.isStopped = !0;
          var a = o(this.t.onCompleted).call(this.t);
          if (a === _a)
    ...
    zb["do"] = zb.tap = zb.doAction = function(a, b, c) {
      return new uc(this, a, b, c);
    }, zb.doOnNext = zb.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, zb.doOnError = zb.tapOnError = function(a, b) {
      return this.tap(ca, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, zb.doOnCompleted = zb.tapOnCompleted = function(a, b) {
      return this.tap(ca, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, zb["finally"] = zb.ensure = function(a) {
      var b = this;
      return new Jc(function(c) {
        var d;
        try {
    ...
    zb.ignoreElements = function() {
      return new vc(this);
    }, zb.materialize = function() {
      var a = this;
      return new Jc(function(b) {
        return a.subscribe(function(a) {
          b.onNext(Cb(a));
    ...
    var wc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new K(a, this));
      }, b;
    }(Lb);
    K.prototype.onNext = function(a) {
      if (!this.isStopped) {
      ...
      var a,
          b,
          c = !1;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new wc(this, b, c, a);
    }, zb.skipLast = function(a) {
      if (0 > a)
        throw new ra;
      var b = this;
      return new Jc(function(c) {
    ...
    }, zb.startWith = function() {
      var a,
          b = 0;
      arguments.length && rb(arguments[0]) ? (a = arguments[0], b = 1) : a = ub;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Sb([ac(c, a), this]).concat();
    }, zb.takeLast = function(a) {
      if (0 > a)
        throw new ra;
      var b = this;
      return new Jc(function(c) {
    ...
    }, zb.selectConcat = zb.concatMap = function(a, b, c) {
      return ja(a) && ja(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return ia(e) && (e = Cc(e)), (za(e) || ya(e)) && (e = $b(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : ja(a) ? L(this, a, c) : L(this, function() {
        return a;
      });
    };
    var xc = function(a) {
      ...
      return bb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          var b = o(this.selector)(a, this.i++, this.source);
          return b === _a ? this.o.onError(b.e) : void this.o.onNext(b);
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    }, zb.selectMany = zb.flatMap = function(a, b, c) {
      return ja(a) && ja(b) ? this.flatMap(function(c, d) {
        var e = a(c, d);
        return ia(e) && (e = Cc(e)), (za(e) || ya(e)) && (e = $b(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }, c) : ja(a) ? M(this, a, c) : M(this, function() {
        return a;
      });
    }, zb.selectSwitch = zb.flatMapLatest = zb.switchMap = function(a, b) {
    ...
    var zc = function(a) {
      ...
      return bb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = o(this.predicate)(a, this.i++, this.source);
          return b === _a ? this.o.onError(b.e) : void(b && this.o.onNext(a));
        }
      }, d.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, d.prototype.onCompleted = function() {
    ...
    zb.filter = zb.where = function(a, b) {
      return this instanceof zc ? this.internalFilter(a, b) : new zc(this, a, b);
    }, Jb.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, Jb.fromNodeCallback = function(a, b, c) {
      return function() {
        for (var d = arguments.length,
            e = new Array(d),
            f = 0; d > f; f++)
    ...
    }, ba.config.useNativeEvents = !1, Jb.fromEvent = function(a, b, c) {
      return a.addListener ? Ac(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : ba.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Jc(function(d) {
      ...
      }).publish().refCount() : Ac(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var Ac = Jb.fromEventPattern = function(a, b, c) {
      return new Jc(function(d) {
        function e(a) {
          var b = a;
          if (c)
        ...
        Cc = Jb.fromPromise = function(a) {
          return new Bc(a);
        };
    zb.toPromise = function(a) {
      ...
      return Cc(b);
    }, zb.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new Jc(function(d) {
        var e = c.multicast(a());
        return new fb(b(e).subscribe(d), e.connect());
      }, c) : new Dc(c, a);
    }, zb.publish = function(a) {
      return a && ja(a) ? this.multicast(function() {
        return new Mc;
      }, a) : this.multicast(new Mc);
    }, zb.share = function() {
      return this.publish().refCount();
    }, zb.publishLast = function(a) {
      return a && ja(a) ? this.multicast(function() {
        return new Nc;
      }, a) : this.multicast(new Nc);
    }, zb.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new Pc(b);
      }, a) : this.multicast(new Pc(a));
    }, zb.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, zb.replay = function(a, b, c, d) {
      return a && ja(a) ? this.multicast(function() {
        return new Qc(b, c, d);
      }, a) : this.multicast(new Qc(b, c, d));
    }, zb.shareReplay = function(a, b, c) {
      return this.replay(null, a, b, c).refCount();
    };
    {
      var Dc = ba.ConnectableObservable = function(a) {
        function b(b, c) {
          var d,
              e = !1,
              f = b.asObservable();
        ...
        return bb(b, a), b.prototype.refCount = function() {
          ...
          Ec = Jb.interval = function(a, b) {
            return S(a, a, rb(b) ? b : Ab);
          };
      Jb.timer = function(b, c, d) {
        var e;
        return rb(d) || (d = Ab), c !== a && "number" == typeof c ? e = c : rb(c) && (d = c), b instanceof Date && e === a ? P(b.getTime(), d) : b instanceof Date && e !== a ? (e = c, Q(b.getTime(), e, d)) : e === a ? R(b, d) : S(b, e, d);
      };
    }
    zb.delay = function(a, b) {
      return rb(b) || (b = Ab), a instanceof Date ? U(this, a.getTime(), b) : T(this, a, b);
    }, zb.debounce = zb.throttleWithTimeout = function(a, b) {
      rb(b) || (b = Ab);
      var c = this;
      return new Jc(function(d) {
        var e,
    ...
    }, zb.throttle = function(a, b) {
      return this.debounce(a, b);
    }, zb.timestamp = function(a) {
      return rb(a) || (a = Ab), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, zb.sample = zb.throttleLatest = function(a, b) {
      return rb(b) || (b = Ab), "number" == typeof a ? V(this, Ec(a, b)) : V(this, a);
    }, zb.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = ic(new Error(b || "Timeout"))), rb(c) || (c = Ab);
      var d = this,
      ...
      return new Jc(function(f) {
        function g() {
          ...
          l.setDisposable(c[e](a, function() {
            h === d && (ia(b) && (b = Cc(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new mb,
    ...
    var Fc = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Mc, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
    ...
    var Gc = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = W(this.source, this.pauser.distinctUntilChanged().startWith(!1), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new Mc, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
    ...
    zb.pausableBuffered = function(a) {
    ...
    var Hc = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new Ic(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return bb(c, a), c.prototype.request = function(a) {
        ...
        Ic = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Mc, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = jb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || vb;
          }
          return bb(c, a), cb(c.prototype, Fb, {
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                var d = b._processRequest(c),
                    e = d.numberOfItems;
                d.returnValue || (b.requestedCount = e, b.requestedDisposable = ib(function() {
                  b.requestedCount = 0;
                }));
    ...
    zb.controlled = function(a, b) {
      return a && rb(a) && (b = a, a = !0), null == a && (a = !0), new Hc(this, a, b);
    }, zb.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    var Jc = ba.AnonymousObservable = function(a) {
      function b(a) {
        return a && ja(a.dispose) ? a : ja(a) ? ib(a) : jb;
      }
      function c(a, c) {
      ...
      function d(b, d) {
        function e(a) {
          var d = new Kc(a),
              e = [d, b];
          return vb.scheduleRequired() ? vb.scheduleWithState(e, c) : c(null, e), d;
        }
    ...
    var Mc = ba.Subject = function(a) {
      function c(a) {
        return lb(this), this.isStopped ? this.hasError ? (a.onError(this.error), jb) : (a.onCompleted(), jb) : (this.observers.push(a), new Lc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return bb(d, a), cb(d.prototype, Fb.prototype, {
        ...
        Nc = ba.AsyncSubject = function(a) {
          function c(a) {
            return lb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), jb) : (this.observers.push(a), new Lc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return bb(d, a), cb(d.prototype, Fb, {
            hasObservers: function() {
        ...
        Oc = ba.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return bb(c, a), cb(c.prototype, Fb.prototype, {
            onCompleted: function() {
        ...
        Pc = ba.BehaviorSubject = function(a) {
          function c(a) {
            return lb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), jb) : (this.observers.push(a), a.onNext(this.value), new Lc(this, a));
          }
          function d(b) {
        ...
        Qc = ba.ReplaySubject = function(a) {
          function c(a, b) {
            return ib(function() {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || vb, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return bb(e, a), cb(e.prototype, Fb.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
    ...
    }(Mc), "function" == typeof define && "object" == typeof define.amd && define.amd ? (Y.Rx = ba, define(function() {
      return ba;
