...
(function(process) {
  (function(a) {
    ...
    function C(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && z(b) ? (b = B(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > $b ? $b : b) : b;
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    function E(a, b) {
      return pb(a) || (a = tb), new ac(b, a);
    }
    function F(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function N(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return ca(e) && (e = Ub(e)), (ta(e) || sa(e)) && (e = _b(e)), e;
      }).concatAll();
    }
    function O(a, b, c) {
      for (var d = 0,
    ...
    var ab = X.internals.PriorityQueue = function(a) {
    ...
    var cb = X.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var eb = X.Disposable = function(a) {
    ...
    var fb = eb.create = function(a) {
      return new eb(a);
        ...
        jb = X.SingleAssignmentDisposable = function() {
    ...
    var kb = X.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var lb = X.RefCountDisposable = function() {
      function a(a) {
    ...
    var mb = X.internals.ScheduledItem = function(a, b, c, d, e) {
    ...
    var qb,
        rb,
        sb = (X.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
    ...
    !function() {
      ...
      if (da(h))
        ...
        S.addEventListener ? S.addEventListener("message", c, !1) : S.attachEvent ? S.attachEvent("onmessage", c) : S.onmessage = c, qb = function(a) {
          var b = d++;
        ...
        qb = "document" in S && "onreadystatechange" in S.document.createElement("script") ? function(b) {
      ...
      return Wa(e, a), e.prototype._clone = function(a) {
        ...
        yb = X.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return pb(a) || (a = sb), new Dc(function(c) {
    ...
    Cb.prototype.toNotifier = function() {
      ...
      return new Gb(this.onNext.bind(this), this.onError.bind(this), this.onCompleted.bind(this));
    }, Cb.prototype.checked = function() {
      return new Hb(this);
    };
    var Db = Cb.create = function(a, b, c) {
      return a || (a = Y), b || (b = ba), c || (c = Y), new Gb(a, b, c);
    };
    Cb.fromNotifier = function(a, b) {
      return new Gb(function(c) {
    ...
    var Eb,
        Fb = X.internals.AbstractObserver = function(a) {
          function b() {
        ...
        Gb = X.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Ib = X.internals.ScheduledObserver = function(a) {
          function b(b, c) {
        ...
        Kb = X.Observable = function() {
          ...
          return Eb = a.prototype, Eb.subscribe = Eb.forEach = function(a, b, c) {
        ...
        Lb = X.ObservableBase = function(a) {
          function b(a) {
        ...
        Mb = X.internals.Enumerable = function() {},
        Nb = function(a) {
          function b(b) {
          ...
          return Wa(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                d = new kb,
                e = sb.scheduleRecursiveWithState(this.sources[qa](), function(e, f) {
                  if (!b) {
    ...
    Eb.toArray = function() {
      return new Vb(this);
    }, Kb.create = Kb.createWithDisposable = function(a, b) {
      return new Dc(a, b);
    };
    var Wb = (Kb.defer = function(a) {
      return new Dc(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return kc(d).subscribe(b);
        }
        return ca(c) && (c = Ub(c)), c.subscribe(b);
      });
    }, function(a) {
      function b(b) {
      ...
      return Wa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Xb = Kb.empty = function(a) {
          return pb(a) || (a = sb), new Wb(a);
        },
        Yb = function(a) {
          function b(b, c, d) {
    ...
    var _b = Kb.from = function(a, b, c, d) {
      if (null == a)
    ...
    var bc = Kb.fromArray = function(a, b) {
      return pb(b) || (b = tb), new ac(a, b);
    };
    Kb.generate = function(a, b, c, d, e) {
      return pb(e) || (e = tb), new Dc(function(f) {
        var g = !0;
    ...
    var ic = function(a) {
      ...
      return Wa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        jc = (Kb["return"] = Kb.just = Kb.returnValue = function(a, b) {
          return pb(b) || (b = sb), new ic(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        kc = Kb["throw"] = Kb.throwError = Kb.throwException = function(a, b) {
          return pb(b) || (b = sb), new jc(a, b);
        };
    Kb.using = function(a, b) {
      return new Dc(function(c) {
        ...
        try {
          ...
          return new cb(kc(g).subscribe(c), f);
        }
      ...
      return new Dc(function(c) {
        ...
        var f,
            ...
            i = new jb,
            j = new jb;
        return ca(a) && (a = Ub(a)), i.setDisposable(b.subscribe(function(a) {
          d(), f === g && c.onNext(a);
        }, function(a) {
          d(), f === g && c.onError(a);
        }, function() {
      ...
      for (var d = 0,
        ...
        b = a(b, c[d]);
      return b;
    }, Eb["catch"] = Eb.catchError = Eb.catchException = function(a) {
      return "function" == typeof a ? H(this, a) : lc([this, a]);
    };
    var lc = Kb.catchError = Kb["catch"] = Kb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    var mc = Kb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Dc(function(a) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new jb;
            ca(f) && (f = Ub(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Eb.concatAll = Eb.concatObservable = function() {
      return this.merge(1);
    };
    var pc = function(a) {
      function b(b, c) {
      ...
      return Wa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        qc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new jb;
            this.g.add(c), ca(a) && (a = Ub(a)), c.setDisposable(a.subscribe(new b(this, c)));
      ...
      return Array.isArray(c[0]) && (c = c[0]), E(a, c).mergeAll();
        ...
        sc = function(a) {
          ...
          return Wa(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new jb;
              this.g.add(b), ca(a) && (a = Ub(a)), b.setDisposable(a.subscribe(new d(this, this.g, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    Eb.mergeAll = Eb.mergeObservable = function() {
      return new sc(this);
    };
    var tc = X.CompositeError = function(a) {
    ...
    tc.prototype = Error.prototype, Kb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Dc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : a.onError(1 === g.length ? g[0] : new tc(g));
        }
        var c = new cb,
            e = new jb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new jb;
          c.add(e), ca(d) && (d = Ub(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var uc = Kb.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Dc(function(b) {
        var c = 0,
            ...
            e = sb.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], ca(f) && (f = Ub(f)), g = new jb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new cb(d, e);
      });
    };
    ...
    var vc = function(a) {
      ...
      return Wa(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new jb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), ca(a) && (a = Ub(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var wc = function(a) {
      function b(b, c) {
        this.source = b, this.other = ca(c) ? Ub(c) : c, a.call(this);
      }
      function c(a) {
    ...
    Eb.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Dc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new jb;
            ca(d) && (d = Ub(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      return b.unshift(d), new Dc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var i = b[c],
                j = new jb;
            ca(i) && (i = Ub(i)), j.setDisposable(i.subscribe(function(b) {
      ...
      return new Dc(function(b) {
        for (var c = a.length,
            ...
            g = 0; c > g; g++)
          !function(c) {
            f[c] = new jb, f[c].setDisposable(a[c].subscribe(function(a) {
      ...
      var c = this;
      return b || (b = _), new Dc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
    ...
    var xc = function(a) {
      function b(b, c, d, e) {
        this.source = b, this.t = !c || da(c) ? Db(c || Y, d || Y, e || Y) : c, a.call(this);
      }
      function c(a, b) {
    ...
    }, Eb["finally"] = Eb.ensure = function(a) {
      var b = this;
      return new Dc(function(c) {
        var d;
        try {
    ...
    M.prototype.onNext = function(a) {
      ...
      var a,
          b,
          c = !1;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new zc(this, b, c, a);
    ...
    }, Eb.selectConcat = Eb.concatMap = function(a, b, c) {
      return da(a) && da(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return ca(e) && (e = Ub(e)), (ta(e) || sa(e)) && (e = _b(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      ...
      return new Dc(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          ca(c) && (c = Ub(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          ca(b) && (b = Ub(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, Eb.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Dc(function(a) {
        var d = !1;
    ...
    Eb.map = Eb.select = function(a, b) {
      ...
      return this instanceof Ac ? this.internalMap(c, b) : new Ac(this, c, b);
    }, Eb.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, Eb.selectMany = Eb.flatMap = function(a, b, c) {
      ...
      return new Dc(function(f) {
        ...
        return e.subscribe(function(b) {
          ...
          ca(c) && (c = Ub(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          ca(a) && (a = Ub(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Eb.selectSwitch = Eb.flatMapLatest = Eb.switchMap = function(a, b) {
    ...
    Eb.filter = Eb.where = function(a, b) {
      return this instanceof Cc ? this.internalFilter(a, b) : new Cc(this, a, b);
    ...
    var Dc = X.AnonymousObservable = function(a) {
      function b(a) {
        return a && da(a.dispose) ? a : da(a) ? fb(a) : gb;
      }
      function c(a, c) {
    ...
    var Gc = X.Subject = function(a) {
      function c(a) {
        return ib(this), this.isStopped ? this.hasError ? (a.onError(this.error), gb) : (a.onCompleted(), gb) : (this.observers.push(a), new Fc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return Wa(d, a), Xa(d.prototype, Cb.prototype, {
        ...
        Hc = (X.AsyncSubject = function(a) {
          function c(a) {
            return ib(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), gb) : (this.observers.push(a), new Fc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return Wa(d, a), Xa(d.prototype, Cb, {
            hasObservers: function() {
        ...
        }(Kb), X.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Wa(c, a), Xa(c.prototype, Cb.prototype, {
            onCompleted: function() {
